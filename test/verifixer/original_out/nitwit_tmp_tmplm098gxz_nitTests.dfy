...
method Failing()
{
  ...
  // Test case for combination {1}/Bb=1,p=3,q=1:
  //   PRE:  valid_base(b)
  //   PRE:  bibble(b, p)
  //   PRE:  bibble(b, q)
  //   POST: bibble(b, r)
  ...
  // Test case for combination {1}/Bb=1,p=3,q=0:
  //   PRE:  valid_base(b)
  //   PRE:  bibble(b, p)
  //   PRE:  bibble(b, q)
  //   POST: bibble(b, r)
  ...
  // Test case for combination {1}/Bb=0,p=1:
  //   PRE:  valid_base(b)
  //   PRE:  bibble(b, p)
  //   POST: bibble(b, r)
  {
  ...
  // Test case for combination {1}/Bb=0,p=2:
  //   PRE:  valid_base(b)
  //   PRE:  bibble(b, p)
  //   POST: bibble(b, r)
  {
