...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\original\Program-Verification-Dataset_tmp_tmpgbdrlnu__Dafny_advanced examples_ReverseString.dfy
// Method: yarra
// Generated: 2026-04-22 21:36:27
...
method TestsForyarra()
{
  ...
  //   POST Q3: reversed(arr, outarr)
  {
    ...
    expect outarr[..] == ['}'];
    expect arr[..] == }; // observed from implementation
    expect outarr == }; // observed from implementation
  }
  ...
  //   POST Q3: reversed(arr, outarr)
  {
    var arr := new char[2] ['o', 'o'];
    var outarr := yarra(arr);
    expect outarr[..] == ['o', 'o'];
    expect arr[..] == oo; // observed from implementation
    expect outarr == oo; // observed from implementation
  }
...
{
  TestsForyarra();
  print "TestsForyarra: all non-failing tests passed!\n";
}
