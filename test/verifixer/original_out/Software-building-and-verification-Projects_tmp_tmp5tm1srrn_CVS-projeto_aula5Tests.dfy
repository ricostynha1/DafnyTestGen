...
method TestsForadd()
{
  ...
  //   POST Q1: RepInv()
  {
    var n := 1;
    var obj := new Set(n);
    var tmp_store := new int[3] [2, 4, 10];
    obj.store := tmp_store;
    obj.nelems := 2;
    obj.Repr := {obj, obj.store};
    var v := 2;
