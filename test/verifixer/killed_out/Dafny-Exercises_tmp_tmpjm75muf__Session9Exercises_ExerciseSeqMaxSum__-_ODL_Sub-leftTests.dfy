...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\killed\Dafny-Exercises_tmp_tmpjm75muf__Session9Exercises_ExerciseSeqMaxSum__-_ODL_Sub-left.dfy
// Method: segMaxSum
// Generated: 2026-04-01 13:56:21
...
method Passing()
{
  ...
  //   POST: 0 <= k <= i && s == Sum(v, k, i + 1) && SumMaxToRight(v, i, s)
  {
    var v := new int[1] [4];
    var i := 0;
    expect v.Length > 0 && 0 <= i < v.Length; // PRE-CHECK
  ...
  // Test case for combination {1}/Bv=2,i=1:
  //   PRE:  v.Length > 0 && 0 <= i < v.Length
  //   POST: 0 <= k <= i && s == Sum(v, k, i + 1) && SumMaxToRight(v, i, s)
  {
    var v := new int[2] [4, 3];
