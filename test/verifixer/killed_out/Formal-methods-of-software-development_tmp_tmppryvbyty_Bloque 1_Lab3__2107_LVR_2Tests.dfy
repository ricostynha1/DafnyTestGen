...
method GeneratedTests_multipleReturns()
{
...
method GeneratedTests_multipleReturns2()
{
  // Test case for combination {1}:
  //   PRE:  y > 0
  //   POST: more + less == 2 * x
...
method GeneratedTests_multipleReturns3()
{
  // Test case for combination {1}:
  //   PRE:  y > 0
  //   POST: more - less == 2 * y
...
method Main()
{
  GeneratedTests_multipleReturns();
  print "GeneratedTests_multipleReturns: all tests passed!\n";
  GeneratedTests_multipleReturns2();
  print "GeneratedTests_multipleReturns2: all tests passed!\n";
  GeneratedTests_multipleReturns3();
  print "GeneratedTests_multipleReturns3: all tests passed!\n";
