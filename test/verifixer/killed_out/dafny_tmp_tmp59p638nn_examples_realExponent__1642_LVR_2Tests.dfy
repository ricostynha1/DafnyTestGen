...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\killed\dafny_tmp_tmp59p638nn_examples_realExponent__1642_LVR_2.dfy
// Method: pow
// Generated: 2026-03-25 22:48:07
...
method GeneratedTests_pow()
{
  // Test case for combination {1}:
  //   PRE:  n > 0
  //   PRE:  alpha > 0.0
  //   POST: product == power(n as real, alpha)
  {
    var n := 1;
    var alpha := 0.0;
    var product := pow(n, alpha);
    expect product == power(n as real, alpha);
  }
  ...
  // Test case for combination {1}/Bn=1,alpha=1.0:
  //   PRE:  n > 0
  //   PRE:  alpha > 0.0
  //   POST: product == power(n as real, alpha)
  {
...
{
  GeneratedTests_pow();
  print "GeneratedTests_pow: all tests passed!\n";
}
