...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\killed\BPTree-verif_tmp_tmpq1z6xm1d_Utils__11949_VER_key.dfy
// Method: GetInsertIndex
// Generated: 2026-04-22 21:26:00
...
method TestsForInsertIntoSorted()
{
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect b[..] == [5, 8, 9, 10, 24762, 24766, 24767, 0]; // observed from implementation
  }
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    var key := 1;
    var b := InsertIntoSorted(a, limit, key);
    // actual runtime state: b=[1, 8, 0, 0]
