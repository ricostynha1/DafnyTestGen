...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\killed\dafny-synthesis_task_id_399__419_VER_result.dfy
// Method: BitwiseXOR
// Generated: 2026-04-22 21:42:31
...
method TestsForBitwiseXOR()
{
  ...
  //   POST Q2: forall i: int {:trigger b[i]} {:trigger a[i]} {:trigger result[i]} :: 0 <= i < |result| ==> result[i] == a[i] ^ b[i]
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyTestGen_xy241a4zvfe\runner.cs:line 1262
    // expect |result| == |a|;
