...
// Source: C:\Dados\Dafny\DafnyTestGen\test\verifixer\not_supported\Dafny_tmp_tmp0wu8wmfr_tests_Search1000__2813_VER_n.dfy
// Method: Search2PowLoop
// Generated: 2026-04-08 21:54:06
  ...
  decreases n
{
  ...
  if a[i + n / 2] < x {
    ...
    k := Search2PowRecursive(a, n, n / 2, x);
  }
}
...
method Passing()
{
  ...
  // Test case for combination {1}/Ba=0,i=0,n==a_len,x=0:
  //   PRE:  0 <= i <= i + n <= a.Length
  //   PRE:  forall p: int, q: int {:trigger a[q], a[p]} | i <= p < q < i + n :: a[p] <= a[q]
  //   PRE:  Is2Pow(n + 1)
  //   POST: i <= k <= i + n
  ...
  // Test case for combination {1}/Ba=0,i=0,n==a_len,x=1:
  //   PRE:  0 <= i <= i + n <= a.Length
  //   PRE:  forall p: int, q: int {:trigger a[q], a[p]} | i <= p < q < i + n :: a[p] <= a[q]
  //   PRE:  Is2Pow(n + 1)
  //   POST: i <= k <= i + n
  ...
  // Test case for combination {1}/Ba=1,i=0,n=0,x=0:
  //   PRE:  0 <= i <= i + n <= a.Length
  //   PRE:  forall p: int, q: int {:trigger a[q], a[p]} | i <= p < q < i + n :: a[p] <= a[q]
  //   PRE:  Is2Pow(n + 1)
  //   POST: i <= k <= i + n
