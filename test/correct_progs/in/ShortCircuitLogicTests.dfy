...
method GeneratedTests_GetFirstOrZero()
{
...
method GeneratedTests_ZeroLengthOrValue()
{
...
method Main()
{
  GeneratedTests_GetFirstOrZero();
  print "GeneratedTests_GetFirstOrZero: all tests passed!\n";
  GeneratedTests_ZeroLengthOrValue();
  print "GeneratedTests_ZeroLengthOrValue: all tests passed!\n";
}
