...
method TestsForSumOfCommonDivisors()
{
...
method Main()
{
  TestsForSumOfCommonDivisors();
  print "TestsForSumOfCommonDivisors: all non-failing tests passed!\n";
}
