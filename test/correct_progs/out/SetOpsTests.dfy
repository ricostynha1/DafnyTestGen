...
method TestsForSetContainsColor()
{
  ...
  // Test case for combination {1}/Oc=Blue:
  //   PRE:  |S| > 0
  //   POST: r == (c in S)
  //   ENSURES: r == (c in S)
  {
