...
method TestsForSetUnionNat()
{
  ...
  //   ENSURES: C == A + B
  {
    var A: set<nat> := {0, 4, 6, 7};
    var B: set<nat> := {0, 4, 6, 7};
    var C := SetUnionNat(A, B);
    expect C == {0, 4, 6, 7};
  }
