// Dafny program ModeTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/ModeTests.dfy --no-verify
// ModeTests.dfy
  ...
  decreases a
{
  ...
  for i: int := 1 to a.Length
    ...
    invariant forall k: int {:trigger a[k]} :: 0 <= k < i ==> Count(a[..i], a[k]) <= best_count
  ...
  decreases s
{
  if |s| == 0 then
    ...
    (if s[|s| - 1] == x then 1 else 0) + Count(s[..|s| - 1], x)
}
...
{
  {
    var a := new int[1] [38];
    var m := Mode(a);
    expect m in a[..], ""expectation violation"";
    expect forall k: int {:trigger a[k]} :: 0 <= k < a.Length ==> Count(a[..], a[k]) <= Count(a[..], m), ""expectation violation"";
  }
  {
    var a := new int[2] [3, 3];
    var m := Mode(a);
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger Mode(BigInteger[] a)
    {
      BigInteger m = BigInteger.Zero;
      BigInteger _0_best__m;
      _0_best__m = (a)[(int)(BigInteger.Zero)];
      BigInteger _1_best__count;
      _1_best__count = BigInteger.One;
      BigInteger _2_current__count;
      _2_current__count = BigInteger.One;
      BigInteger _hi0 = new BigInteger((a).Length);
      for (BigInteger _3_i = BigInteger.One; _3_i < _hi0; _3_i++) {
        if (((a)[(int)(_3_i)]) == ((a)[(int)((_3_i) - (BigInteger.One))])) {
          _2_current__count = (_2_current__count) + (BigInteger.One);
          if ((_2_current__count) > (_1_best__count)) {
            _1_best__count = _2_current__count;
            _0_best__m = (a)[(int)(_3_i)];
          }
        } else {
          _2_current__count = BigInteger.One;
        }
    ...
    public static BigInteger Count<__T>(Dafny.ISequence<__T> s, __T x)
    {
    ...
    TAIL_CALL_START: ;
      if ((new BigInteger((s).Count)).Sign == 0) {
        ...
        _0___accumulator = (_0___accumulator) + (((object.Equals((s).Select((new BigInteger((s).Count)) - (BigInteger.One)), x)) ? (BigInteger.One) : (BigInteger.Zero)));
        Dafny.ISequence<__T> _in0 = (s).Take((new BigInteger((s).Count)) - (BigInteger.One));
        __T _in1 = x;
        s = _in0;
        x = _in1;
    ...
    public static void GeneratedTests__Mode()
    {
      {
        BigInteger[] _0_a;
        BigInteger[] _nw0 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.One, "array size exceeds memory limit")];
        _nw0[(int)((int)(BigInteger.Zero))] = new BigInteger(38);
        _0_a = _nw0;
        BigInteger _1_m;
        BigInteger _out0;
        _out0 = __default.Mode(_0_a);
        _1_m = _out0;
        if (!((Dafny.Helpers.SeqFromArray(_0_a)).Contains(_1_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(68,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_2_a, _3_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_2_a).Length)), true, (((_forall_var_0) => {
          BigInteger _4_k = (BigInteger)_forall_var_0;
          return !(((_4_k).Sign != -1) && ((_4_k) < (new BigInteger((_2_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_2_a), (_2_a)[(int)(_4_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_2_a), _3_m)));
        }))))(_0_a, _1_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(69,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _5_a;
        ...
        BigInteger _6_m;
        BigInteger _out1;
        _out1 = __default.Mode(_5_a);
        _6_m = _out1;
        if (!((Dafny.Helpers.SeqFromArray(_5_a)).Contains(_6_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(82,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_7_a, _8_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_7_a).Length)), true, (((_forall_var_1) => {
          BigInteger _9_k = (BigInteger)_forall_var_1;
          return !(((_9_k).Sign != -1) && ((_9_k) < (new BigInteger((_7_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_7_a), (_7_a)[(int)(_9_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_7_a), _8_m)));
        }))))(_5_a, _6_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(83,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _10_a;
        BigInteger[] _nw2 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        _nw2[(int)((int)(BigInteger.Zero))] = new BigInteger(4);
        _nw2[(int)((int)(BigInteger.One))] = new BigInteger(4);
        _nw2[(int)((int)(new BigInteger(2)))] = new BigInteger(4);
        _10_a = _nw2;
        BigInteger _11_m;
        BigInteger _out2;
        _out2 = __default.Mode(_10_a);
        _11_m = _out2;
        if (!((Dafny.Helpers.SeqFromArray(_10_a)).Contains(_11_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(96,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_12_a, _13_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_12_a).Length)), true, (((_forall_var_2) => {
          BigInteger _14_k = (BigInteger)_forall_var_2;
          return !(((_14_k).Sign != -1) && ((_14_k) < (new BigInteger((_12_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_12_a), (_12_a)[(int)(_14_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_12_a), _13_m)));
        }))))(_10_a, _11_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(97,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _15_a;
        BigInteger[] _nw3 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw3[(int)((int)(BigInteger.Zero))] = new BigInteger(-38);
        _nw3[(int)((int)(BigInteger.One))] = BigInteger.Zero;
        _nw3[(int)((int)(new BigInteger(2)))] = BigInteger.Zero;
        _nw3[(int)((int)(new BigInteger(3)))] = new BigInteger(7719);
        _15_a = _nw3;
        BigInteger _16_m;
        BigInteger _out3;
        _out3 = __default.Mode(_15_a);
        _16_m = _out3;
        if (!((Dafny.Helpers.SeqFromArray(_15_a)).Contains(_16_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(110,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_17_a, _18_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_17_a).Length)), true, (((_forall_var_3) => {
          BigInteger _19_k = (BigInteger)_forall_var_3;
          return !(((_19_k).Sign != -1) && ((_19_k) < (new BigInteger((_17_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_17_a), (_17_a)[(int)(_19_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_17_a), _18_m)));
        }))))(_15_a, _16_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(111,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _20_a;
        BigInteger[] _nw4 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(5), "array size exceeds memory limit")];
        _nw4[(int)((int)(BigInteger.Zero))] = new BigInteger(-38);
        _nw4[(int)((int)(BigInteger.One))] = BigInteger.Zero;
        _nw4[(int)((int)(new BigInteger(2)))] = BigInteger.Zero;
        _nw4[(int)((int)(new BigInteger(3)))] = BigInteger.Zero;
        _nw4[(int)((int)(new BigInteger(4)))] = new BigInteger(7719);
        _20_a = _nw4;
        BigInteger _21_m;
        BigInteger _out4;
        _out4 = __default.Mode(_20_a);
        _21_m = _out4;
        if (!((Dafny.Helpers.SeqFromArray(_20_a)).Contains(_21_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(124,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_22_a, _23_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_22_a).Length)), true, (((_forall_var_4) => {
          BigInteger _24_k = (BigInteger)_forall_var_4;
          return !(((_24_k).Sign != -1) && ((_24_k) < (new BigInteger((_22_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_22_a), (_22_a)[(int)(_24_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_22_a), _23_m)));
        }))))(_20_a, _21_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(125,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _25_a;
        BigInteger[] _nw5 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(6), "array size exceeds memory limit")];
        _nw5[(int)((int)(BigInteger.Zero))] = new BigInteger(-38);
        _nw5[(int)((int)(BigInteger.One))] = BigInteger.Zero;
        _nw5[(int)((int)(new BigInteger(2)))] = BigInteger.Zero;
        _nw5[(int)((int)(new BigInteger(3)))] = BigInteger.Zero;
        _nw5[(int)((int)(new BigInteger(4)))] = BigInteger.Zero;
        _nw5[(int)((int)(new BigInteger(5)))] = new BigInteger(7719);
        _25_a = _nw5;
        BigInteger _26_m;
        BigInteger _out5;
        _out5 = __default.Mode(_25_a);
        _26_m = _out5;
        if (!((Dafny.Helpers.SeqFromArray(_25_a)).Contains(_26_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(138,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(Dafny.Helpers.Id<Func<BigInteger[], BigInteger, bool>>((_27_a, _28_m) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_27_a).Length)), true, (((_forall_var_5) => {
          BigInteger _29_k = (BigInteger)_forall_var_5;
          return !(((_29_k).Sign != -1) && ((_29_k) < (new BigInteger((_27_a).Length)))) || ((__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_27_a), (_27_a)[(int)(_29_k)])) <= (__default.Count<BigInteger>(Dafny.Helpers.SeqFromArray(_27_a), _28_m)));
        }))))(_25_a, _26_m))) {
          throw new Dafny.HaltException("test/correct_progs/out/ModeTests.dfy(139,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__Mode();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_Mode: all tests passed!\n")).ToVerbatimString(false));
    }
  }
