...
method Passing()
{
  ...
  //   ENSURES: sorted <==> forall i :: 0 <= i < a.Length - 1 ==> a[i] <= a[i + 1]
  {
    var a := new int[6] [-2437, 0, -1, 32285, -8365, 11797];
    var sorted := IsSortedArr(a);
    expect sorted == false;
  }
  ...
  //   ENSURES: sorted <==> forall i :: 0 <= i < a.Length - 1 ==> a[i] <= a[i + 1]
  {
    var a := new int[5] [-32285, 8365, 0, -10451, -10451];
    var sorted := IsSortedArr(a);
    expect sorted == false;
  }
  ...
  //   ENSURES: sorted <==> forall i :: 0 <= i < a.Length - 1 ==> a[i] <= a[i + 1]
  {
    var a := new int[4] [2438, 2438, 2438, 0];
    var sorted := IsSortedArr(a);
    expect sorted == false;
  }
