...
method Passing()
{
  ...
  // Test case for combination {2}/Barr=1,elem=0,arr-shape=const:
  //   PRE:  forall i, j :: 0 <= i < j < arr.Length ==> arr[i] <= arr[j]
  //   POST: !(elem !in arr[..])
  //   POST: elem in arr[..]
  //   POST: 0 <= pos < arr.Length
  ...
  // Test case for combination {2}/Barr=1,elem=1,arr-shape=const:
  //   PRE:  forall i, j :: 0 <= i < j < arr.Length ==> arr[i] <= arr[j]
  //   POST: !(elem !in arr[..])
  //   POST: elem in arr[..]
  //   POST: 0 <= pos < arr.Length
  ...
  // Test case for combination {2}/Opos>0:
  //   PRE:  forall i, j :: 0 <= i < j < arr.Length ==> arr[i] <= arr[j]
  //   POST: !(elem !in arr[..])
  //   POST: elem in arr[..]
  //   POST: 0 <= pos < arr.Length
  ...
  // Test case for combination {3}/Opos<0:
  //   PRE:  forall i, j :: 0 <= i < j < arr.Length ==> arr[i] <= arr[j]
  //   POST: elem !in arr[..]
  //   POST: pos == -1
  //   POST: !(elem in arr[..])
