// Dafny program FibonacciTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/FibonacciTests.dfy --no-verify
// FibonacciTests.dfy
...
{
  {
    var n := 0;
    var res := CalcFib(n);
    expect res == Fib(n), ""expectation violation"";
  }
  {
    var n := 2;
    var res := CalcFib(n);
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static BigInteger CalcFib(BigInteger n)
    {
      ...
      for (BigInteger _2_i = BigInteger.Zero; _2_i < _hi0; _2_i++) {
        BigInteger _rhs2 = _1_y;
        BigInteger _rhs3 = (_0_x) + (_1_y);
        _0_x = _rhs2;
        _1_y = _rhs3;
      }
      res = _0_x;
    ...
    public static void GeneratedTests__CalcFib()
    {
      {
        BigInteger _0_n;
        ...
        BigInteger _1_res;
        BigInteger _out0;
        _out0 = __default.CalcFib(_0_n);
        _1_res = _out0;
        if (!((_1_res) == (__default.Fib(_0_n)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FibonacciTests.dfy(41,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _2_n;
        _2_n = new BigInteger(2);
        BigInteger _3_res;
        BigInteger _out1;
        _out1 = __default.CalcFib(_2_n);
        _3_res = _out1;
        if (!((_3_res) == (__default.Fib(_2_n)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FibonacciTests.dfy(51,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _4_n;
        _4_n = BigInteger.One;
        BigInteger _5_res;
        BigInteger _out2;
        _out2 = __default.CalcFib(_4_n);
        _5_res = _out2;
        if (!((_5_res) == (__default.Fib(_4_n)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FibonacciTests.dfy(61,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _6_n;
        _6_n = new BigInteger(3);
        BigInteger _7_res;
        BigInteger _out3;
        _out3 = __default.CalcFib(_6_n);
        _7_res = _out3;
        if (!((_7_res) == (__default.Fib(_6_n)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FibonacciTests.dfy(71,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__CalcFib();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_CalcFib: all tests passed!\n")).ToVerbatimString(false));
    }
  }
