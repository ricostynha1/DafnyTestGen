// Dafny program BinarySearchIndexTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/BinarySearchIndexTests.dfy --no-verify
// BinarySearchIndexTests.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static bool IsSorted(Dafny.ISequence<BigInteger> a) {
    ...
    public static void GeneratedTests__BinarySearch()
    {
      {
        BigInteger[] _0_a;
        ...
        _0_a = _nw0;
        BigInteger _1_x;
        _1_x = new BigInteger(8);
        BigInteger _2_index;
        BigInteger _out0;
        _out0 = __default.BinarySearch(_0_a, _1_x);
        _2_index = _out0;
        if (!((_2_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/BinarySearchIndexTests.dfy(53,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _3_a;
        ...
        _3_a = _nw1;
        BigInteger _4_x;
        _4_x = new BigInteger(17);
        BigInteger _5_index;
        BigInteger _out1;
        _out1 = __default.BinarySearch(_3_a, _4_x);
        _5_index = _out1;
        if (!((_5_index).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/BinarySearchIndexTests.dfy(68,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _6_a;
        BigInteger[] _nw2 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw2[(int)((int)(BigInteger.Zero))] = new BigInteger(-7719);
        ...
        BigInteger _8_index;
        BigInteger _out2;
        _out2 = __default.BinarySearch(_6_a, _7_x);
        _8_index = _out2;
        if (!((_8_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/BinarySearchIndexTests.dfy(82,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _9_a;
        ...
        _9_a = _nw3;
        BigInteger _10_x;
        _10_x = new BigInteger(3);
        BigInteger _11_index;
        BigInteger _out3;
        _out3 = __default.BinarySearch(_9_a, _10_x);
        _11_index = _out3;
        if (!((_11_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/BinarySearchIndexTests.dfy(96,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _12_a;
        BigInteger[] _nw4 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw4[(int)((int)(BigInteger.Zero))] = new BigInteger(-21238);
        _nw4[(int)((int)(BigInteger.One))] = new BigInteger(7719);
        _12_a = _nw4;
        BigInteger _13_x;
        _13_x = new BigInteger(-21238);
        BigInteger _14_index;
        BigInteger _out4;
        _out4 = __default.BinarySearch(_12_a, _13_x);
        _14_index = _out4;
        if (!((_14_index).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/BinarySearchIndexTests.dfy(111,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__BinarySearch();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_BinarySearch: all tests passed!\n")).ToVerbatimString(false));
    }
  }
