// Dafny program FindMaxTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/FindMaxTests.dfy --no-verify
// FindMaxTests.dfy
...
{
  {
    ...
    var max := FindMax(a);
    expect max == 0.0, ""expectation violation"";
  }
  {
  ...
  }
  {
    ...
    var max := FindMax(a);
    expect max == 0.5, ""expectation violation"";
  }
  {
    var a := new real[3] [-39.0, -39.0, -39.0];
    var max := FindMax(a);
    expect max == -39.0, ""expectation violation"";
  }
  {
...
namespace _module {
  ...
  public partial class __default {
    public static Dafny.BigRational FindMax(Dafny.BigRational[] a)
    {
      ...
      for (BigInteger _0_i = BigInteger.One; _0_i < _hi0; _0_i++) {
        if (((a)[(int)(_0_i)]) > (max)) {
          max = (a)[(int)(_0_i)];
        }
      }
    ...
    public static void GeneratedTests__FindMax()
    {
      {
        ...
        _nw0[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _0_a = _nw0;
        Dafny.BigRational _1_max;
        Dafny.BigRational _out0;
        _out0 = __default.FindMax(_0_a);
        _1_max = _out0;
        if (!((_1_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(37,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _2_a;
        Dafny.BigRational[] _nw1 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        _nw1[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw1[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw1[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _2_a = _nw1;
        Dafny.BigRational _3_max;
        Dafny.BigRational _out1;
        _out1 = __default.FindMax(_2_a);
        _3_max = _out1;
        if (!((_3_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(49,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _4_a;
        Dafny.BigRational[] _nw2 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw2[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw2[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _4_a = _nw2;
        Dafny.BigRational _5_max;
        Dafny.BigRational _out2;
        _out2 = __default.FindMax(_4_a);
        _5_max = _out2;
        if (!((_5_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(61,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _6_a;
        Dafny.BigRational[] _nw3 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw3[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"));
        _nw3[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _6_a = _nw3;
        Dafny.BigRational _7_max;
        Dafny.BigRational _out3;
        _out3 = __default.FindMax(_6_a);
        _7_max = _out3;
        if (!((_7_max) == (new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"))))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(74,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _8_a;
        Dafny.BigRational[] _nw4 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        _nw4[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw4[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw4[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _8_a = _nw4;
        Dafny.BigRational _9_max;
        Dafny.BigRational _out4;
        _out4 = __default.FindMax(_8_a);
        _9_max = _out4;
        if (!((_9_max) == (new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(87,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _10_a;
        Dafny.BigRational[] _nw5 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw5[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw5[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _nw5[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-7719"), BigInteger.One);
        _nw5[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-21238"), BigInteger.One);
        _10_a = _nw5;
        Dafny.BigRational _11_max;
        Dafny.BigRational _out5;
        _out5 = __default.FindMax(_10_a);
        _11_max = _out5;
        if (!((_11_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(100,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _12_a;
        Dafny.BigRational[] _nw6 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw6[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw6[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _nw6[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"));
        _nw6[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-7719"), BigInteger.One);
        _12_a = _nw6;
        Dafny.BigRational _13_max;
        Dafny.BigRational _out6;
        _out6 = __default.FindMax(_12_a);
        _13_max = _out6;
        if (!((_13_max) == (new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"))))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(112,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _14_a;
        Dafny.BigRational[] _nw7 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(8), "array size exceeds memory limit")];
        _nw7[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(4)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(5)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(6)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw7[(int)((int)(new BigInteger(7)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _14_a = _nw7;
        Dafny.BigRational _15_max;
        Dafny.BigRational _out7;
        _out7 = __default.FindMax(_14_a);
        _15_max = _out7;
        if (!((_15_max) == (new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(124,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _16_a;
        Dafny.BigRational[] _nw8 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(6), "array size exceeds memory limit")];
        _nw8[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _nw8[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-7719"), BigInteger.One);
        _nw8[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-21238"), BigInteger.One);
        _nw8[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-2437"), BigInteger.One);
        _nw8[(int)((int)(new BigInteger(4)))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw8[(int)((int)(new BigInteger(5)))] = new Dafny.BigRational(BigInteger.Parse("-8855"), BigInteger.One);
        _16_a = _nw8;
        Dafny.BigRational _17_max;
        Dafny.BigRational _out8;
        _out8 = __default.FindMax(_16_a);
        _17_max = _out8;
        if (!((_17_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(136,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _18_a;
        Dafny.BigRational[] _nw9 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw9[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw9[(int)((int)(BigInteger.One))] = new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"));
        _18_a = _nw9;
        Dafny.BigRational _19_max;
        Dafny.BigRational _out9;
        _out9 = __default.FindMax(_18_a);
        _19_max = _out9;
        if (!((_19_max) == (new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"))))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(149,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _20_a;
        Dafny.BigRational[] _nw10 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw10[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _nw10[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-7719"), BigInteger.One);
        _nw10[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-21238"), BigInteger.One);
        _nw10[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _20_a = _nw10;
        Dafny.BigRational _21_max;
        Dafny.BigRational _out10;
        _out10 = __default.FindMax(_20_a);
        _21_max = _out10;
        if (!((_21_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(162,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _22_a;
        Dafny.BigRational[] _nw11 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        _nw11[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"));
        _nw11[(int)((int)(BigInteger.One))] = new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"));
        _nw11[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _22_a = _nw11;
        Dafny.BigRational _23_max;
        Dafny.BigRational _out11;
        _out11 = __default.FindMax(_22_a);
        _23_max = _out11;
        if (!((_23_max) == (new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"))))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(174,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _24_a;
        Dafny.BigRational[] _nw12 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw12[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw12[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw12[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _nw12[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One);
        _24_a = _nw12;
        Dafny.BigRational _25_max;
        Dafny.BigRational _out12;
        _out12 = __default.FindMax(_24_a);
        _25_max = _out12;
        if (!((_25_max) == (new Dafny.BigRational(BigInteger.Parse("-39"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(186,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _26_a;
        Dafny.BigRational[] _nw13 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(5), "array size exceeds memory limit")];
        _nw13[(int)((int)(BigInteger.Zero))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw13[(int)((int)(BigInteger.One))] = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
        _nw13[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _nw13[(int)((int)(new BigInteger(3)))] = new Dafny.BigRational(BigInteger.Parse("-7719"), BigInteger.One);
        _nw13[(int)((int)(new BigInteger(4)))] = new Dafny.BigRational(BigInteger.Parse("-21238"), BigInteger.One);
        _26_a = _nw13;
        Dafny.BigRational _27_max;
        Dafny.BigRational _out13;
        _out13 = __default.FindMax(_26_a);
        _27_max = _out13;
        if (!((_27_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(198,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__FindMax();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_FindMax: all tests passed!\n")).ToVerbatimString(false));
    }
  }
