  ...
  public partial class __default {
    ...
    public static void GeneratedTests__FindMax()
    {
      ...
      }
      {
        ...
        _nw2[(int)((int)(BigInteger.One))] = new Dafny.BigRational(new BigInteger(-5), BigInteger.Parse("10"));
        _4_a = _nw2;
        ...
        if (!((_5_max) == (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(62,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        Dafny.BigRational[] _6_a;
        Dafny.BigRational[] _nw3 = new Dafny.BigRational[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        ...
        _nw3[(int)((int)(new BigInteger(2)))] = new Dafny.BigRational(BigInteger.Parse("-38"), BigInteger.One);
        _6_a = _nw3;
        ...
        if (!((_7_max) == (new Dafny.BigRational(new BigInteger(5), BigInteger.Parse("10"))))) {
          throw new Dafny.HaltException("test/correct_progs/out/FindMaxTests.dfy(75,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
