...
method TestsForElementWiseDivision()
{
...
method Main()
{
  TestsForElementWiseDivision();
  print "TestsForElementWiseDivision: all non-failing tests passed!\n";
}
