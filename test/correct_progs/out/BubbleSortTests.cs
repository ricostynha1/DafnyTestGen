// Dafny program BubbleSortTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/BubbleSortTests.dfy --no-verify
// BubbleSortTests.dfy
...
{
  {
    var a := new int[0] [];
    BubbleSort(a);
    expect a[..] == [], ""expectation violation"";
  }
  {
    var a := new int[1] [2];
    BubbleSort(a);
    expect a[..] == [2], ""expectation violation"";
  }
  {
    var a := new int[2] [7681, -38];
    BubbleSort(a);
    expect a[..] == [-38, 7681], ""expectation violation"";
  }
  {
    var a := new int[3] [-38, -2, 1234];
    BubbleSort(a);
    expect a[..] == [-38, -2, 1234], ""expectation violation"";
  }
}
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static bool IsPartitionedAndRightSorted(Dafny.ISequence<BigInteger> s, BigInteger n)
    {
      return Dafny.Helpers.Id<Func<Dafny.ISequence<BigInteger>, BigInteger, bool>>((_0_s, _1_n) => Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange(BigInteger.Zero, new BigInteger((_0_s).Count)), true, (((_forall_var_0) => {
        BigInteger _2_i = (BigInteger)_forall_var_0;
        return Dafny.Helpers.Quantifier<BigInteger>(Dafny.Helpers.IntegerRange((_2_i) + (BigInteger.One), new BigInteger((_0_s).Count)), true, (((_forall_var_1) => {
          BigInteger _3_j = (BigInteger)_forall_var_1;
          return !(((((_2_i).Sign != -1) && ((_2_i) < (_3_j))) && ((_3_j) < (new BigInteger((_0_s).Count)))) && ((_3_j) >= (_1_n))) || (((_0_s).Select(_2_i)) <= ((_0_s).Select(_3_j)));
        })));
      }))))(s, n);
    }
    public static void BubbleSort(BigInteger[] a)
    {
      ...
      while ((_0_n) > (BigInteger.One)) {
        BigInteger _1_newn;
        _1_newn = BigInteger.Zero;
        BigInteger _hi0 = _0_n;
        for (BigInteger _2_i = BigInteger.One; _2_i < _hi0; _2_i++) {
          if (((a)[(int)((_2_i) - (BigInteger.One))]) > ((a)[(int)(_2_i)])) {
            BigInteger _index0 = (_2_i) - (BigInteger.One);
            BigInteger _rhs0 = (a)[(int)(_2_i)];
            BigInteger _rhs1 = (a)[(int)((_2_i) - (BigInteger.One))];
            BigInteger[] _lhs0 = a;
            BigInteger _lhs1 = (_2_i) - (BigInteger.One);
            BigInteger[] _lhs2 = a;
            BigInteger _lhs3 = _2_i;
    ...
    public static void GeneratedTests__BubbleSort()
    {
      {
        BigInteger[] _0_a;
        ...
        if (!((Dafny.Helpers.SeqFromArray(_0_a)).Equals(Dafny.Sequence<BigInteger>.FromElements()))) {
          throw new Dafny.HaltException("test/correct_progs/out/BubbleSortTests.dfy(69,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _1_a;
        BigInteger[] _nw1 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.One, "array size exceeds memory limit")];
        _nw1[(int)((int)(BigInteger.Zero))] = new BigInteger(2);
        _1_a = _nw1;
        __default.BubbleSort(_1_a);
        if (!((Dafny.Helpers.SeqFromArray(_1_a)).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(2))))) {
          throw new Dafny.HaltException("test/correct_progs/out/BubbleSortTests.dfy(80,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _2_a;
        BigInteger[] _nw2 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw2[(int)((int)(BigInteger.Zero))] = new BigInteger(7681);
        _nw2[(int)((int)(BigInteger.One))] = new BigInteger(-38);
        _2_a = _nw2;
        __default.BubbleSort(_2_a);
        if (!((Dafny.Helpers.SeqFromArray(_2_a)).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(-38), new BigInteger(7681))))) {
          throw new Dafny.HaltException("test/correct_progs/out/BubbleSortTests.dfy(91,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _3_a;
        ...
        _nw3[(int)((int)(new BigInteger(2)))] = new BigInteger(1234);
        _3_a = _nw3;
        __default.BubbleSort(_3_a);
        if (!((Dafny.Helpers.SeqFromArray(_3_a)).Equals(Dafny.Sequence<BigInteger>.FromElements(new BigInteger(-38), new BigInteger(-2), new BigInteger(1234))))) {
          throw new Dafny.HaltException("test/correct_progs/out/BubbleSortTests.dfy(102,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__BubbleSort();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_BubbleSort: all tests passed!\n")).ToVerbatimString(false));
    }
  }
