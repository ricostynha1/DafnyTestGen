...
method TestsForIntersection()
{
  ...
  {
    var a := new int[5] [32, 73, 74, 73, 76];
    var b := new int[3] [74, 32, 73];
    ...
    expect res == [32, 73, 74]; // observed from implementation
  }
