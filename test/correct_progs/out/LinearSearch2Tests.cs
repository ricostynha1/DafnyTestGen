...
method GeneratedTests_LinearSearch()
{
  ...
  }
  {
    ...
    var x := 9;
    var index := LinearSearch(a, x);
    expect index == 1 || index == 0, ""expectation violation"";
  }
  {
    var a := new int[1] [11];
    var x := 9;
  ...
  public partial class __default {
    ...
    public static void GeneratedTests__LinearSearch()
    {
      ...
      }
      {
        ...
        _8_index = _out2;
        if (!(((_8_index) == (BigInteger.One)) || ((_8_index).Sign == 0))) {
      ...
      }
      {
        ...
        if (!((_11_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(73,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
