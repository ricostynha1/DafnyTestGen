// Dafny program LinearSearch2Tests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/LinearSearch2Tests.dfy --no-verify
// LinearSearch2Tests.dfy
...
{
  {
    ...
    expect index == 0, ""expectation violation"";
  }
  {
    var a := new int[3] [17, 8, 24];
    var x := 8;
    var index := LinearSearch(a, x);
    expect index == 1, ""expectation violation"";
  }
  {
    var a := new int[2] [9, 9];
    var x := 9;
    var index := LinearSearch(a, x);
    expect 0 <= index < a.Length, ""expectation violation"";
    expect a[index] == x, ""expectation violation"";
  }
  {
    var a := new int[1] [11];
    var x := 9;
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger LinearSearch(BigInteger[] a, BigInteger x)
    {
    ...
    public static void GeneratedTests__LinearSearch()
    {
      {
        BigInteger[] _0_a;
        ...
        _0_a = _nw0;
        BigInteger _1_x;
        _1_x = new BigInteger(4);
        BigInteger _2_index;
        BigInteger _out0;
        _out0 = __default.LinearSearch(_0_a, _1_x);
        _2_index = _out0;
        if (!((_2_index).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(38,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _3_a;
        ...
        _nw1[(int)((int)(new BigInteger(2)))] = new BigInteger(24);
        _3_a = _nw1;
        BigInteger _4_x;
        _4_x = new BigInteger(8);
        BigInteger _5_index;
        BigInteger _out1;
        _out1 = __default.LinearSearch(_3_a, _4_x);
        _5_index = _out1;
        if (!((_5_index) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(50,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _6_a;
        BigInteger[] _nw2 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw2[(int)((int)(BigInteger.Zero))] = new BigInteger(9);
        _nw2[(int)((int)(BigInteger.One))] = new BigInteger(9);
        _6_a = _nw2;
        BigInteger _7_x;
        _7_x = new BigInteger(9);
        BigInteger _8_index;
        BigInteger _out2;
        _out2 = __default.LinearSearch(_6_a, _7_x);
        _8_index = _out2;
        if (!(((_8_index).Sign != -1) && ((_8_index) < (new BigInteger((_6_a).Length))))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(62,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(((_6_a)[(int)(_8_index)]) == (_7_x))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(63,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _9_a;
        BigInteger[] _nw3 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.One, "array size exceeds memory limit")];
        _nw3[(int)((int)(BigInteger.Zero))] = new BigInteger(11);
        _9_a = _nw3;
        BigInteger _10_x;
        _10_x = new BigInteger(9);
        BigInteger _11_index;
        BigInteger _out3;
        _out3 = __default.LinearSearch(_9_a, _10_x);
        _11_index = _out3;
        if (!((_11_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(74,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _12_a;
        BigInteger[] _nw4 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw4[(int)((int)(BigInteger.Zero))] = new BigInteger(6);
        _nw4[(int)((int)(BigInteger.One))] = new BigInteger(6);
        _12_a = _nw4;
        BigInteger _13_x;
        _13_x = new BigInteger(6);
        BigInteger _14_index;
        BigInteger _out4;
        _out4 = __default.LinearSearch(_12_a, _13_x);
        _14_index = _out4;
        if (!(((_14_index).Sign != -1) && ((_14_index) < (new BigInteger((_12_a).Length))))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(87,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(((_12_a)[(int)(_14_index)]) == (_13_x))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(88,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _15_a;
        ...
        _15_a = _nw5;
        BigInteger _16_x;
        _16_x = new BigInteger(3);
        BigInteger _17_index;
        BigInteger _out5;
        _out5 = __default.LinearSearch(_15_a, _16_x);
        _17_index = _out5;
        if (!((_17_index).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(101,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _18_a;
        BigInteger[] _nw6 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
        _nw6[(int)((int)(BigInteger.Zero))] = new BigInteger(18);
        _nw6[(int)((int)(BigInteger.One))] = new BigInteger(9);
        _nw6[(int)((int)(new BigInteger(2)))] = new BigInteger(24);
        _18_a = _nw6;
        BigInteger _19_x;
        _19_x = new BigInteger(9);
        BigInteger _20_index;
        BigInteger _out6;
        _out6 = __default.LinearSearch(_18_a, _19_x);
        _20_index = _out6;
        if (!((_20_index) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(113,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _21_a;
        BigInteger[] _nw7 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(4), "array size exceeds memory limit")];
        _nw7[(int)((int)(BigInteger.Zero))] = new BigInteger(15);
        _nw7[(int)((int)(BigInteger.One))] = new BigInteger(15);
        _nw7[(int)((int)(new BigInteger(2)))] = new BigInteger(23);
        _nw7[(int)((int)(new BigInteger(3)))] = new BigInteger(22);
        _21_a = _nw7;
        BigInteger _22_x;
        _22_x = new BigInteger(15);
        BigInteger _23_index;
        BigInteger _out7;
        _out7 = __default.LinearSearch(_21_a, _22_x);
        _23_index = _out7;
        if (!(((_23_index).Sign != -1) && ((_23_index) < (new BigInteger((_21_a).Length))))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(125,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(((_21_a)[(int)(_23_index)]) == (_22_x))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(126,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _24_a;
        BigInteger[] _nw8 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw8[(int)((int)(BigInteger.Zero))] = new BigInteger(14);
        _nw8[(int)((int)(BigInteger.One))] = new BigInteger(6);
        _24_a = _nw8;
        BigInteger _25_x;
        _25_x = new BigInteger(6);
        BigInteger _26_index;
        BigInteger _out8;
        _out8 = __default.LinearSearch(_24_a, _25_x);
        _26_index = _out8;
        if (!((_26_index) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(139,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _27_a;
        BigInteger[] _nw9 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.One, "array size exceeds memory limit")];
        _nw9[(int)((int)(BigInteger.Zero))] = new BigInteger(5);
        _27_a = _nw9;
        BigInteger _28_x;
        _28_x = new BigInteger(5);
        BigInteger _29_index;
        BigInteger _out9;
        _out9 = __default.LinearSearch(_27_a, _28_x);
        _29_index = _out9;
        if (!((_29_index).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(152,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _30_a;
        BigInteger[] _nw10 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw10[(int)((int)(BigInteger.Zero))] = new BigInteger(10);
        _nw10[(int)((int)(BigInteger.One))] = new BigInteger(10);
        _30_a = _nw10;
        BigInteger _31_x;
        _31_x = new BigInteger(10);
        BigInteger _32_index;
        BigInteger _out10;
        _out10 = __default.LinearSearch(_30_a, _31_x);
        _32_index = _out10;
        if (!(((_32_index).Sign != -1) && ((_32_index) < (new BigInteger((_30_a).Length))))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(164,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(((_30_a)[(int)(_32_index)]) == (_31_x))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(165,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _33_a;
        BigInteger[] _nw11 = new BigInteger[Dafny.Helpers.ToIntChecked(new BigInteger(2), "array size exceeds memory limit")];
        _nw11[(int)((int)(BigInteger.Zero))] = new BigInteger(11);
        _nw11[(int)((int)(BigInteger.One))] = new BigInteger(11);
        _33_a = _nw11;
        BigInteger _34_x;
        _34_x = new BigInteger(11);
        BigInteger _35_index;
        BigInteger _out11;
        _out11 = __default.LinearSearch(_33_a, _34_x);
        _35_index = _out11;
        if (!(((_35_index).Sign != -1) && ((_35_index) < (new BigInteger((_33_a).Length))))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(177,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
        if (!(((_33_a)[(int)(_35_index)]) == (_34_x))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(178,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger[] _36_a;
        BigInteger[] _nw12 = new BigInteger[Dafny.Helpers.ToIntChecked(BigInteger.Zero, "array size exceeds memory limit")];
        _36_a = _nw12;
        BigInteger _37_x;
        _37_x = new BigInteger(8);
        BigInteger _38_index;
        BigInteger _out12;
        _out12 = __default.LinearSearch(_36_a, _37_x);
        _38_index = _out12;
        if (!((_38_index) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/LinearSearch2Tests.dfy(189,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__LinearSearch();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_LinearSearch: all tests passed!\n")).ToVerbatimString(false));
    }
  }
