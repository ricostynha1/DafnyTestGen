...
method Passing()
{
  ...
  // Test case for combination {2}/Bn=0,a=1:
  //   POST: !(result)
  //   POST: !(forall i :: 0 <= i < a.Length ==> n > a[i])
  {
    var n := 0;
  ...
  {
    var n := 0;
    var a := new int[3] [5, 7719, 6];
    var result := IsGreater(n, a);
    expect result == false;
  }

  // Test case for combination {2}/Bn=1,a=1:
  //   POST: !(result)
  //   POST: !(forall i :: 0 <= i < a.Length ==> n > a[i])
  {
    var n := 1;
