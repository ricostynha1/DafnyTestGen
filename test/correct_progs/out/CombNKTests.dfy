...
method TestsForCalcComb()
{
  // Test case for combination {1}:
  //   PRE:  0 <= k <= n
  //   POST Q1: res == Comb(n, k)
  {
    var n := 10;
    var k := 0;
  ...
  // Test case for combination {3}/Bk=1:
  //   PRE:  0 <= k <= n
  //   POST Q1: res == Comb(n, k)
  {
    var n := 10;
  ...
  // Test case for combination {2}/On=1:
  //   PRE:  0 <= k <= n
  //   POST Q1: res == Comb(n, k)
  {
    var n := 1;
...
{
  TestsForCalcComb();
  print "TestsForCalcComb: all non-failing tests passed!\n";
}
