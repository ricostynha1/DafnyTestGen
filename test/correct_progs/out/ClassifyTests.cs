// Dafny program ClassifyTests.dfy compiled into C#
...
// Command-line arguments: run test/correct_progs/out/ClassifyTests.dfy --no-verify
// ClassifyTests.dfy
...
{
  {
    var x := 97;
    var r := Classify(x);
    expect r == 1, ""expectation violation"";
  }
  {
    var x := 0;
    var r := Classify(x);
    expect r == 0, ""expectation violation"";
  }
  {
    var x := -4;
    var r := Classify(x);
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger Classify(BigInteger x)
    {
    ...
    public static void GeneratedTests__Classify()
    {
      {
        BigInteger _0_x;
        _0_x = new BigInteger(97);
        BigInteger _1_r;
        BigInteger _out0;
        _out0 = __default.Classify(_0_x);
        _1_r = _out0;
        if (!((_1_r) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(37,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _2_x;
        _2_x = BigInteger.Zero;
        BigInteger _3_r;
        BigInteger _out1;
        _out1 = __default.Classify(_2_x);
        _3_r = _out1;
        if (!((_3_r).Sign == 0)) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(52,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _4_x;
        _4_x = new BigInteger(-4);
        BigInteger _5_r;
        BigInteger _out2;
        _out2 = __default.Classify(_4_x);
        _5_r = _out2;
        if (!((_5_r) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(67,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _6_x;
        _6_x = BigInteger.One;
        BigInteger _7_r;
        BigInteger _out3;
        _out3 = __default.Classify(_6_x);
        _7_r = _out3;
        if (!((_7_r) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(82,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _8_x;
        _8_x = new BigInteger(98);
        BigInteger _9_r;
        BigInteger _out4;
        _out4 = __default.Classify(_8_x);
        _9_r = _out4;
        if (!((_9_r) == (BigInteger.One))) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(97,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
      {
        BigInteger _10_x;
        _10_x = new BigInteger(-100);
        BigInteger _11_r;
        BigInteger _out5;
        _out5 = __default.Classify(_10_x);
        _11_r = _out5;
        if (!((_11_r) == (new BigInteger(-1)))) {
          throw new Dafny.HaltException("test/correct_progs/out/ClassifyTests.dfy(112,4): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString("expectation violation").ToVerbatimString(false));}
      }
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.GeneratedTests__Classify();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("GeneratedTests_Classify: all tests passed!\n")).ToVerbatimString(false));
    }
  }
