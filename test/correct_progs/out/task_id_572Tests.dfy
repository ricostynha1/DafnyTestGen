...
method Passing()
{
  ...
  //   POST: !(|a[..]| <= 1)
  //   POST: res == if (a[..][|a[..]| - 1]) in (a[..][0 .. |a[..]| - 1]) then (if |(a[..][0 .. |a[..]| - 1])| <= 1 then (a[..][0 .. |a[..]| - 1]) else if ((a[..][0 .. |a[..]| - 1])[|(a[..][0 .. |a[..]| - 1])| - 1]) in ((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1]) then DeDup(((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1])) else DeDup(((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1])) + [((a[..][0 .. |a[..]| - 1])[|(a[..][0 .. |a[..]| - 1])| - 1])]) else (if |(a[..][0 .. |a[..]| - 1])| <= 1 then (a[..][0 .. |a[..]| - 1]) else if ((a[..][0 .. |a[..]| - 1])[|(a[..][0 .. |a[..]| - 1])| - 1]) in ((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1]) then DeDup(((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1])) else DeDup(((a[..][0 .. |a[..]| - 1])[0 .. |(a[..][0 .. |a[..]| - 1])| - 1])) + [((a[..][0 .. |a[..]| - 1])[|(a[..][0 .. |a[..]| - 1])| - 1])]) + [(a[..][|a[..]| - 1])]
  //   ENSURES: res == DeDup(a[..])
  {
    var a := new int[2] [3, 4];
    var res := RemoveDuplicates<int>(a);
