...
method Passing()
{
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[4] [-0.5, 0.0, 0.0, 0.0];
    var max := FindMax(a);
    expect max == 0.0;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[3] [-38.5, -39.0, -39.0];
    var max := FindMax(a);
    expect max == -38.5;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[4] [0.0, -1.0, -39.0, -7720.0];
    var max := FindMax(a);
    expect max == 0.0;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[4] [0.0, 38.5, 38.5, 38.0];
    var max := FindMax(a);
    expect max == 38.5;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[3] [-39.0, -38.5, -39.0];
    var max := FindMax(a);
    expect max == -38.5;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[5] [-1.0, 0.0, 0.0, 0.0, -39.0];
    var max := FindMax(a);
    expect max == 0.0;
  }
  ...
  //   ENSURES: forall k :: 0 <= k < a.Length ==> max >= a[k]
  {
    var a := new real[4] [-1.0, -39.0, -7720.0, 0.0];
    var max := FindMax(a);
    expect max == 0.0;
  }
