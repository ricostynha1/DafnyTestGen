...
method Passing()
{
  ...
  //   POST: !exists i: int, j: int {:trigger a[j], a[i]} :: 0 <= i < j < a.Length && IsEven(a[i]) && IsOdd(a[j])
  //   POST: multiset(a[..]) == multiset(old(a[..]))
  //   ENSURES: !exists i: int, j: int {:trigger a[j], a[i]} :: 0 <= i < j < a.Length && IsEven(a[i]) && IsOdd(a[j])
  //   ENSURES: multiset(a[..]) == multiset(old(a[..]))
  {
    var a := new nat[0] [];
    PartitionOddEven(a);
  ...
  //   ENSURES: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    var old_a := a[..];
    PartitionOddEven(a);
    expect !exists i: int, j: int :: 0 <= i < j < a.Length && IsEven(a[i]) && IsOdd(a[j]);
