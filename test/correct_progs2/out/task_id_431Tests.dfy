...
// Source: C:\Dados\dafny\DafnyTestGen\test\Correct_progs2\in\task_id_431.dfy
// Method: HasCommonElement
// Generated: 2026-03-21 23:05:59
...
method Passing()
{
  ...
  {
    var a := new int[3] [5, 9, 10];
    var b := new int[3] [11, 5, 12];
    var result := HasCommonElement<int>(a, b);
    expect result == true;
  }

  // Test case for combination {2}/Ba=0,b=0:
  //   POST: !(result)
  //   POST: !(exists i, j :: 0 <= i < a.Length && 0 <= j < b.Length && a[i] == b[j])
  {
    var a := new int[0] [];
  ...
  // Test case for combination {2}/Ba=0,b=2:
  //   POST: !(result)
  //   POST: !(exists i, j :: 0 <= i < a.Length && 0 <= j < b.Length && a[i] == b[j])
  {
    var a := new int[0] [];
  ...
  // Test case for combination {2}/Ba=0,b=3:
  //   POST: !(result)
  //   POST: !(exists i, j :: 0 <= i < a.Length && 0 <= j < b.Length && a[i] == b[j])
  {
    var a := new int[0] [];
