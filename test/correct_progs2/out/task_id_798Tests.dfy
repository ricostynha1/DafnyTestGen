...
// Source: C:\Dados\dafny\DafnyTestGen\test\Correct_progs2\in\task_id_798.dfy
// Method: CalcArraySum
// Generated: 2026-03-21 23:26:44
...
method Passing()
{
  // Test case for combination {1}/Ba=0,n=0:
  //   PRE:  0 <= n <= a.Length
  ...
  // Test case for combination {1}/Ba=2,n==a:
  //   PRE:  0 <= n <= a.Length
  //   POST: sum == ArraySum(a, 0, n)
  {
    var a := new int[2] [4, 3];
  ...
  // Test case for combination {1}/Ba=3,n=0:
  //   PRE:  0 <= n <= a.Length
  //   POST: sum == ArraySum(a, 0, n)
  {
  ...
  // Test case for combination {1}/Ba=3,n==a:
  //   PRE:  0 <= n <= a.Length
  //   POST: sum == ArraySum(a, 0, n)
  {
    var a := new int[3] [5, 4, 6];
