...
// Source: C:\Dados\dafny\DafnyTestGen\test\Correct_progs2\in\task_id_18.dfy
// Method: RemoveChars
// Generated: 2026-03-21 22:59:52
...
method Passing()
{
  // Test case for combination {1}/Bs1=0,s2=0:
  ...
  // Test case for combination {1}/Bs1=1,s2=0:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' '];
    var s2: seq<char> := [];
  ...
  // Test case for combination {1}/Bs1=1,s2=1:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' '];
    var s2: seq<char> := ['F'];
  ...
  // Test case for combination {1}/Bs1=1,s2=2:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := ['F'];
    var s2: seq<char> := ['!', ' '];
  ...
  // Test case for combination {1}/Bs1=1,s2=3:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := ['F'];
    var s2: seq<char> := ['!', ' ', '"'];
  ...
  // Test case for combination {1}/Bs1=2,s2=0:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' ', '!'];
    var s2: seq<char> := [];
  ...
  // Test case for combination {1}/Bs1=2,s2=1:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := ['!', ' '];
    var s2: seq<char> := ['F'];
  ...
  // Test case for combination {1}/Bs1=2,s2=2:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' ', '!'];
    var s2: seq<char> := ['+', ','];
  ...
  // Test case for combination {1}/Bs1=2,s2=3:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' ', '!'];
    var s2: seq<char> := [' ', '!', '"'];
  ...
  // Test case for combination {1}/Bs1=3,s2=2:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' ', '!', '"'];
    var s2: seq<char> := ['+', ','];
  ...
  // Test case for combination {1}/Bs1=3,s2=3:
  //   POST: v == Filter(s1, c => !(c in s2))
  {
    var s1: seq<char> := [' ', '!', '"'];
    var s2: seq<char> := [' ', '!', '\U{005C}'];
    var v := RemoveChars(s1, s2);
    expect v == Filter(s1, c => !(c in s2));
  }
