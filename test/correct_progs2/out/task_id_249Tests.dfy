...
// Source: C:\Dados\dafny\DafnyTestGen\test\Correct_progs2\in\task_id_249.dfy
// Method: Intersection
// Generated: 2026-03-22 11:55:30
...
method Passing()
{
  ...
  //   POST: forall p, q :: 0 <= p < q < |res| ==> exists i, j :: 0 <= i < j < a.Length && a[i] == res[p] && a[j] == res[q]
  {
    var a := new int[3] [42, 8, 53];
    var b := new int[3] [9, 42, 10];
    var res := Intersection<int>(a, b);
    expect res == [42];
  }
