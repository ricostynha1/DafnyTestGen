...
method TestsForMaxSum()
{
  ...
  // Test case for combination {1}/By=x:
  //   POST Q1: s == x + y
  //   POST Q2: x >= y
  //   POST Q3: m == x
  {
...
method TestsForReconstructFromMaxSum()
{
  ...
  //   POST Q5: y <= m
  {
    ...
    // expect x == -12 || x == 2; // got true
    // expect y == 2 || y == -12; // got false
  }

  // FAILING: expects commented out; see VAL/RHS annotations below
  // Test case for combination {1}/By=m:
  //   PRE:  s <= 2 * m
  //   POST Q1: s == x + y
  //   POST Q2: m == x
  //   POST Q3: x <= m
  ...
  //   POST Q5: y <= m
  {
    ...
    var m := 10;
    var x, y := ReconstructFromMaxSum(s, m);
    // actual runtime state: x=10, y=0
    // expect x == -10 || x == 10; // got true
    // expect y == 10 || y == -10; // got false
  }
