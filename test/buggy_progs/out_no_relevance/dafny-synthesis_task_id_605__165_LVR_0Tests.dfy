...
method TestsForIsPrime()
{
  ...
  //   POST Q2: forall k: int {:trigger n % k} :: 2 <= k < n ==> n % k != 0
  {
    ...
    // runtime error: at Dafny.Helpers.EuclideanModulus(BigInteger a, BigInteger b) in C:\cygwin64\tmp\DafnyCBT_irxyq5ritm0\runner.cs:line 1828
    // expect result == true;
  }
