...
method TestsFormin()
{
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 6096
    // expect min == 3;
  }
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 6204
    // expect min == 0;
  }
  ...
  //   POST Q3: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_hf0lzfppvte\runner.cs:line 6240
    // expect min == 0;
  }
