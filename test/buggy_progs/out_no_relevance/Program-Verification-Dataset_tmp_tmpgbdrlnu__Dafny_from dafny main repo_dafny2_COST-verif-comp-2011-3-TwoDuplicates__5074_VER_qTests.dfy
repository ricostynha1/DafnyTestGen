...
method TestsForSearch()
{
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 5986
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 6151
    // expect p == 2 || p == 5;
    // expect q == 5 || q == 2;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 5986
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 6268
    // expect p == 2 || p == 3;
    // expect q == 3 || q == 2;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 5986
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 6307
    // expect p == 5 || p == 3;
    // expect q == 3 || q == 5;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 5986
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_r2kt0oqzlvu\runner.cs:line 6346
    // expect p == 4 || p == 3;
    // expect q == 3 || q == 4;
  }
