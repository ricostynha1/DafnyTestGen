...
method TestsFormergeArr()
{
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    // runtime error: at _module.__default.mergeArr(BigInteger[] a, BigInteger l, BigInteger m, BigInteger r) in C:\cygwin64\tmp\DafnyCBT_g3ekbtczeym\runner.cs:line 6709
    // runtime error: at _module.__default.TestCase__10() in C:\cygwin64\tmp\DafnyCBT_g3ekbtczeym\runner.cs:line 7175
    // expect sorted(a[l .. r]);
    // expect a[..l] == old_a_l;
    // expect a[r..] == old_a_r;
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    var old_a_r := a[r..];
    mergeArr(a, l, m, r);
    // actual runtime state: a=[10, -10, 3]
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [-1, 10, -3, 9, 94]; // observed from implementation
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    var a := new int[5] [-9, -6, -5, 8263, 8263];
    var l := 2;
    var m := 3;
    var r := 5;
    var old_a_l := a[..l];
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.mergeArr(BigInteger[] a, BigInteger l, BigInteger m, BigInteger r) in C:\cygwin64\tmp\DafnyCBT_g3ekbtczeym\runner.cs:line 6709
    // runtime error: at _module.__default.TestCase__14() in C:\cygwin64\tmp\DafnyCBT_g3ekbtczeym\runner.cs:line 7384
    // expect sorted(a[l .. r]);
    // expect a[..l] == old_a_l;
    // expect a[r..] == old_a_r;
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [-8, 2, -9, 7]; // observed from implementation
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [3, -7, -10, -9, 4]; // observed from implementation
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [-8, -10, -10, -9, 96]; // observed from implementation
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [-3, 8, -4, 6]; // observed from implementation
  }
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    expect a[..l] == old_a_l;
    expect a[r..] == old_a_r;
    expect a[..] == [-6, -4, -6, -3]; // observed from implementation
  }
