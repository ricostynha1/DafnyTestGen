...
method TestsForlongest_increasing_subsequence()
{
  ...
  //   POST Q1: max >= 1
  {
    var nums := new int[2] [-10, -1];
    var max := longest_increasing_subsequence(nums);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.longest__increasing__subsequence(BigInteger[] nums) in C:\cygwin64\tmp\DafnyCBT_zhvwzcql4rv\runner.cs:line 5940
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_zhvwzcql4rv\runner.cs:line 6028
    // expect max >= 1;
  }
