...
method TestsForFind()
{
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 5959
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 6072
    // expect 0 <= index ==> index < blood.Length && blood[index] == key;
    // expect index < 0 ==> forall k: int :: 0 <= k < blood.Length ==> blood[k] != key;
  }
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_b5khqxkkphl\runner.cs:line 6295
    // expect 0 <= index ==> index < blood.Length && blood[index] == key;
    // expect index < 0 ==> forall k: int :: 0 <= k < blood.Length ==> blood[k] != key;
  }
