...
method TestsForRoundDown()
{
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_0gxsrmcgrat\runner.cs:line 6731
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_0gxsrmcgrat\runner.cs:line 6152
    // expect r == -1;
  }
...
method TestsForRoundUp()
{
  ...
  {
    var obj := new Rounding;
    var tmp_thresholds := new int[1] [6];
    obj.thresholds := tmp_thresholds;
    var k := 10;
    var r := obj.RoundUp(k);
    expect r == 0 || r == 1;
