...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Dafny_tmp_tmp0wu8wmfr_Heimaverkefni 2_BinarySearchDec__816_ROR_Lt.dfy
// Method: SearchRecursive
// Generated: 2026-04-24 19:43:50
...
method TestsForSearchRecursive()
{
  ...
  //   POST Q4: forall r: int {:trigger a[r]} | k <= r < j :: a[r] < x
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_xy2az2stwyy\runner.cs:line 1656
    // expect k == 1;
  }
  ...
  // FAILING: expects commented out; see VAL/RHS annotations below
  // Test case for combination {1}/Bi=j-1:
  //   PRE:  0 <= i <= j <= |a|
  //   PRE:  forall p: int, q: int {:trigger a[q], a[p]} :: i <= p < q < j ==> a[p] >= a[q]
  //   POST Q1: i <= k
  //   POST Q2: k <= j
