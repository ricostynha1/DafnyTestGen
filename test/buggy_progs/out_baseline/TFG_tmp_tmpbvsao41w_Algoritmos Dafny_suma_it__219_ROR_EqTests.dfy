...
method TestsForsuma_it()
{
  ...
  //   POST Q1: x == suma_vector(V, 0)
  {
    ...
    // runtime error: at _module.__default.suma__it(BigInteger[] V) in C:\cygwin64\tmp\DafnyCBT_haise3idtkf\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_haise3idtkf\runner.cs:line 6005
