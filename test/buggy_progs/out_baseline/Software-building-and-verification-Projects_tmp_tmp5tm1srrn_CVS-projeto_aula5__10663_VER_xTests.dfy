...
method TestsForcontains()
{
  ...
  // Test case for combination {1}/O|store|>=2:
  //   PRE:  RepInv()
  //   PRE:  0 < n
  //   POST Q1: RepInv()
  //   POST Q2: !b
  ...
  //   POST Q9: v in elems
  {
    ...
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 12259
    // runtime error: at _module.GrowingSet.contains(BigInteger v) in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 12220
    // expect b == true || b == false;
  }
...
method TestsForadd()
{
  ...
  //   POST Q1: RepInv()
  {
    ...
    var v := 0;
    obj.add(v);
    expect tmp_store[..] == [0]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    ...
    var v := 1;
    obj.add(v);
    expect tmp_store[..] == [1]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    ...
    var v := 0;
    obj.add(v);
    expect tmp_store[..] == [-2, 0]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    ...
    var v := 17;
    obj.add(v);
    expect tmp_store[..] == [17]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    var n := 6;
    var obj := new Set(n);
    var tmp_store := new int[1] [27];
    obj.store := tmp_store;
    obj.nelems := 0;
    obj.Repr := {obj, obj.store};
    var v := 24;
    obj.add(v);
    expect tmp_store[..] == [24]; // observed from implementation
  }
...
method TestsForfind()
{
  ...
  // Test case for combination {2}/Br=-2:
  //   PRE:  RepInv()
  //   PRE:  0 < n
  //   POST Q1: RepInv()
  //   POST Q2: r < 0 ==> x !in elems
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // expect r < 0 ==> x !in obj.elems; // got true
    // expect r >= 0 ==> x in obj.elems; // got false
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__108() in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 11435
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__109() in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 11478
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__110() in C:\cygwin64\tmp\DafnyCBT_cwpbpcto0kg\runner.cs:line 11521
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
