...
method TestsForremoveElement()
{
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5989
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6097
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6132
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__5() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6167
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6202
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6273
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_oe5u10cczdm\runner.cs:line 6308
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
