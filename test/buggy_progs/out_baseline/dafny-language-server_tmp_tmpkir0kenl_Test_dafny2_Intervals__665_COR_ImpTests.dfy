...
method TestsForRoundDown()
{
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6979
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6202
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6979
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6341
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6979
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6446
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6979
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6482
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6979
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_px2dtgzzga5\runner.cs:line 6518
    // expect r == -1;
  }
