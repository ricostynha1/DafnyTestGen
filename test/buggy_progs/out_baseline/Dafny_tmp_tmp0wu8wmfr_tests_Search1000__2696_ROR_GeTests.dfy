...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Dafny_tmp_tmp0wu8wmfr_tests_Search1000__2696_ROR_Ge.dfy
// Method: Search2PowLoop
// Generated: 2026-04-24 19:44:46
...
method TestsForSearch2PowRecursive()
{
  ...
  //   POST Q3: forall r: int {:trigger a[r]} | k <= r < i + n :: a[r] >= x
  {
    ...
    // expect Is2Pow(n + 1); // PRE-CHECK
    var k := Search2PowRecursive(a, i, n, x);
    // expect i <= k <= i + n; // got true
    // expect forall r: int | i <= r < k :: a[r] < x; // got true
    // expect forall r: int | k <= r < i + n :: a[r] >= x; // got false
  }
