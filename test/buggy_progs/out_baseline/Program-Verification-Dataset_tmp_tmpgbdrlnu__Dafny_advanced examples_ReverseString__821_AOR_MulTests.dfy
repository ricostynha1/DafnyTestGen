...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Program-Verification-Dataset_tmp_tmpgbdrlnu__Dafny_advanced examples_ReverseString__821_AOR_Mul.dfy
// Method: yarra
// Generated: 2026-04-24 20:28:04
...
method TestsForyarra()
{
  ...
  //   POST Q3: reversed(arr, outarr)
  {
    var arr := new char[1] ['\U{0027}'];
    var outarr := yarra(arr);
    expect outarr[..] == ['\U{0027}'];
  }
