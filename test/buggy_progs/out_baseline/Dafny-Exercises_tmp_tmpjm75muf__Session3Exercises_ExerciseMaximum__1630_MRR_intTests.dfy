...
method TestsFormlastMaximum()
{
  ...
  //   POST Q4: forall l: int {:trigger v[l]} :: i < l < v.Length ==> v[i] > v[l]
  {
    ...
    // runtime error: at _module.__default.mlastMaximum(BigInteger[] v) in C:\cygwin64\tmp\DafnyCBT_nxpiglvnn3h\runner.cs:line 6831
    // runtime error: at _module.__default.TestCase__31() in C:\cygwin64\tmp\DafnyCBT_nxpiglvnn3h\runner.cs:line 7754
    // expect i == 1;
  }
