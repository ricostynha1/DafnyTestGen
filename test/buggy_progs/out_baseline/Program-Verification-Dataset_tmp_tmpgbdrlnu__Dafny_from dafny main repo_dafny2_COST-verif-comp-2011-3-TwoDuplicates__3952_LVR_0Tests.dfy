...
method TestsForSearch()
{
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    var p, q := Search(a);
    // actual runtime state: p=5, q=2
    // expect p == 4 || p == 5; // got true
    // expect q == 5 || q == 4; // got false
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    var p, q := Search(a);
    // actual runtime state: p=3, q=2
    // expect p == 3 || p == 0; // got true
    // expect q == 0 || q == 3; // got false
  }
