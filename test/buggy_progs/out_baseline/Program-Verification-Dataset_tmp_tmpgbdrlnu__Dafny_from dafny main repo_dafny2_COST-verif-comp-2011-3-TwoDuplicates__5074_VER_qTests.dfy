...
method TestsForSearch()
{
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 5988
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 6036
    // expect p == 0 || p == 1;
    // expect q == 1 || q == 0;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 5988
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 6071
    // expect p == 1 || p == 0;
    // expect q == 0 || q == 1;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 5988
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 6106
    // expect p == 1 || p == 0;
    // expect q == 0 || q == 1;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[4] [0, 1, 1, 0];
    var p, q := Search(a);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 5988
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 6176
    // expect p == 0 || p == 1;
    // expect q == 1 || q == 0;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[8] [5, 5, 2, 4, 4, 4, 4, 4];
    var p, q := Search(a);
    expect p == 4 || p == 5;
    expect q == 5 || q == 4;
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[8] [3, 2, 4, 3, 0, 0, 3, 3];
    var p, q := Search(a);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 5988
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_shdvosfzalj\runner.cs:line 6289
    // expect p == 3 || p == 0;
    // expect q == 0 || q == 3;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[8] [2, 3, 5, 2, 2, 3, 3, 2];
    var p, q := Search(a);
    expect p == 2 || p == 3;
    expect q == 3 || q == 2;
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[8] [4, 4, 3, 3, 3, 3, 3, 3];
    var p, q := Search(a);
    expect p == 3 || p == 4;
    expect q == 4 || q == 3;
