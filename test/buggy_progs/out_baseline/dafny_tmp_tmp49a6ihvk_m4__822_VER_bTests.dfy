...
method TestsForDutchFlag()
{
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 6003
    // expect a[..] == [White, Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 6041
    // expect a[..] == [Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 6101
    // expect a[..] == [Red, Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_yjz1rukduu1\runner.cs:line 6121
    // expect a[..] == [Red, Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    DutchFlag(a);
    expect a[..] == [Red, Red];
    expect a[..] == [Color.Red, Color.Red]; // observed from implementation
  }
