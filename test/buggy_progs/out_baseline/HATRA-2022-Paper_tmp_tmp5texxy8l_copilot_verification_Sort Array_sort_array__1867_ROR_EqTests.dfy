...
method TestsForsortArray()
{
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[2] [50, 51];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [50, 51]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [33];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [33]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [34];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [34]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [35];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [35]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [36];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [36]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [37];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [37]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    ...
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [38]; // observed from implementation
  }
  ...
  //   POST Q2: multiset(arr[..]) == multiset(arr_sorted[..])
  {
    var arr := new int[1] [39];
    var arr_sorted := sortArray(arr);
    expect sorted(arr_sorted, 0, arr_sorted.Length);
    expect multiset(arr[..]) == multiset(arr_sorted[..]);
    expect arr_sorted[..] == [39]; // observed from implementation
  }
