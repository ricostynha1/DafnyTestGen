...
method TestsFormax()
{
  ...
  //   POST Q2: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 6039
    // expect max == -6;
  }
  ...
  //   POST Q2: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__5() in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 6177
    // expect max == 10;
  }
  ...
  //   POST Q2: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 6248
    // expect max == 0;
  }
  ...
  //   POST Q3: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_s2ujfwg0b3p\runner.cs:line 6284
    // expect max == 0;
  }
