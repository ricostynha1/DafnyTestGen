...
method TestsForotherbSearch()
{
  ...
  //   POST Q6: forall w: int {:trigger v[w]} :: p <= w < v.Length ==> v[w] > elem
  {
    ...
    // runtime error: at _module.__default.otherbSearch(BigInteger[] v, BigInteger elem, Boolean& b, BigInteger& p) in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 6663
    // runtime error: at _module.__default.TestCase__30() in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 7800
    // expect b == false;
    // expect p == 0;
  }
  ...
  //   POST Q6: forall w: int {:trigger v[w]} :: p <= w < v.Length ==> v[w] > elem
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.otherbSearch(BigInteger[] v, BigInteger elem, Boolean& b, BigInteger& p) in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 6663
    // runtime error: at _module.__default.TestCase__34() in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 7972
    // expect b == false;
    // expect p == 0;
  }
  ...
  //   POST Q6: forall w: int {:trigger v[w]} :: p <= w < v.Length ==> v[w] > elem
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.otherbSearch(BigInteger[] v, BigInteger elem, Boolean& b, BigInteger& p) in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 6663
    // runtime error: at _module.__default.TestCase__35() in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 8016
    // expect b == false;
    // expect p == 0;
  }
  ...
  //   POST Q6: forall w: int {:trigger v[w]} :: p <= w < v.Length ==> v[w] > elem
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.otherbSearch(BigInteger[] v, BigInteger elem, Boolean& b, BigInteger& p) in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 6663
    // runtime error: at _module.__default.TestCase__38() in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 8148
    // expect b == false;
    // expect p == 0;
  }
  ...
  //   POST Q6: forall w: int {:trigger v[w]} :: p <= w < v.Length ==> v[w] > elem
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.otherbSearch(BigInteger[] v, BigInteger elem, Boolean& b, BigInteger& p) in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 6663
    // runtime error: at _module.__default.TestCase__39() in C:\cygwin64\tmp\DafnyCBT_wukd5wyy0ha\runner.cs:line 8191
    // expect b == false;
    // expect p == 0;
  }
