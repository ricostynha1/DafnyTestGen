...
method TestsForbest_time_to_buy_and_sell_stock()
{
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5935
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5973
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6010
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6047
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6084
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__5() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6121
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6158
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6195
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6232
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
  ...
  //   POST Q1: forall i: int, j: int {:trigger prices[i], prices[j]} :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.best__time__to__buy__and__sell__stock(BigInteger[] prices) in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 5900
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_qplwpojiq1a\runner.cs:line 6269
    // expect forall i: int, j: int :: 0 <= i < j < prices.Length ==> max_profit >= prices[j] - prices[i];
  }
