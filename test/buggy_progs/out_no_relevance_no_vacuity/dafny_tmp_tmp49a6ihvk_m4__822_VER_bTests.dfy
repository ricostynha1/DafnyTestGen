...
method TestsForDutchFlag()
{
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 5983
    // expect a[..] == [Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 6003
    // expect a[..] == [White, Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 6023
    // expect a[..] == [White, Blue];
  }
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 5933
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_zlqgfigxmjy\runner.cs:line 6141
    // expect a[..] == [Red, Blue];
  }
