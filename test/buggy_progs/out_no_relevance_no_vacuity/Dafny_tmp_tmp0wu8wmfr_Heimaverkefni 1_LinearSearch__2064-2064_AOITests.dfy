...
method TestsForSearchRecursive()
{
  ...
  // Test case for combination {2}/Bk=i+1:
  //   PRE:  0 <= i <= j <= |a|
  //   POST Q1: i <= k
  //   POST Q2: k < j
  //   POST Q3: k != -1
...
method TestsForSearchLoop()
{
  ...
  //   POST Q5: forall r: int {:trigger a[r]} | k < r < j :: a[r] != x
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_odivugeq4io\runner.cs:line 1642
    // expect k == 0;
  }
