...
method TestsFornit_increment()
{
  ...
  // FAILING: expects commented out; see VAL/RHS annotations below
  // Test case for combination {1}/Bsum=0:
  //   PRE:  valid_base(b)
  //   PRE:  nitness(b, n)
  //   POST Q1: nitness(b, sum)
  //   POST Q2: nitness(b, carry)
  ...
  //   POST Q2: nitness(b, carry)
  {
    ...
    var n := 2;
    var sum, carry := nit_increment(b, n);
    // actual runtime state: sum=3, carry=27
    // expect nitness(b, sum); // got true
    // expect nitness(b, carry); // got false
  }
...
method TestsFornit_flip()
{
  ...
  //   POST Q1: nitness(b, nf)
  {
    ...
    var nf := nit_flip(b, n);
    expect nitness(b, nf);
    expect nf == 7; // observed from implementation
  }
...
method TestsFornit_add()
{
  ...
  // Test case for combination {1}/Bz=0:
  //   PRE:  valid_base(b)
  //   PRE:  nitness(b, x)
  //   PRE:  nitness(b, y)
  //   POST Q1: nitness(b, z)
  ...
  //   POST Q3: carry == 0 || carry == 1
  {
    ...
    expect nitness(b, carry);
    expect carry == 0 || carry == 1;
    expect z == 7; // observed from implementation
    expect carry == 1; // observed from implementation
  }
...
method TestsFornit_add_three()
{
  ...
  // Test case for combination P{1}/{1}/Bz=0:
  //   PRE:  valid_base(b)
  //   PRE:  c == 0 || c == 1
  //   PRE:  nitness(b, x)
  //   PRE:  nitness(b, y)
...
method TestsForbibble_add()
{
  ...
  {
    var b := 10;
    var p: seq<nat> := [3, 9, 3, 9];
    var q: seq<nat> := [6, 9, 9, 9];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [0, 9, 3, 8]; // observed from implementation
  }
  ...
  {
    var b := 9;
    var p: seq<nat> := [2, 6, 2, 8];
    var q: seq<nat> := [7, 3, 8, 8];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [1, 1, 2, 7]; // observed from implementation
  }
  ...
  {
    var b := 8;
    var p: seq<nat> := [4, 4, 7, 6];
    var q: seq<nat> := [4, 4, 4, 0];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [1, 1, 3, 6]; // observed from implementation
  }
  ...
  {
    var b := 10;
    var p: seq<nat> := [5, 7, 2, 4];
    var q: seq<nat> := [9, 5, 9, 0];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [5, 3, 1, 4]; // observed from implementation
  }
  ...
  {
    var b := 6;
    var p: seq<nat> := [2, 5, 4, 5];
    var q: seq<nat> := [5, 5, 3, 5];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [2, 5, 2, 4]; // observed from implementation
  }
  ...
  {
    var b := 10;
    var p: seq<nat> := [2, 3, 8, 7];
    var q: seq<nat> := [8, 7, 9, 6];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [1, 1, 8, 3]; // observed from implementation
  }
  ...
  {
    var b := 7;
    var p: seq<nat> := [6, 6, 2, 6];
    var q: seq<nat> := [3, 6, 2, 0];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [3, 5, 4, 6]; // observed from implementation
  }
  ...
  {
    var b := 10;
    var p: seq<nat> := [9, 8, 9, 7];
    var q: seq<nat> := [6, 8, 2, 7];
    var r := bibble_add(b, p, q);
    expect bibble(b, r);
    expect r == [6, 7, 2, 4]; // observed from implementation
  }
...
method TestsForbibble_increment()
{
  ...
  {
    var b := 7;
    var p: seq<nat> := [3, 6, 3, 6];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [3, 6, 4, 0]; // observed from implementation
  }
  ...
  {
    var b := 8;
    var p: seq<nat> := [7, 7, 5, 2];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [7, 7, 5, 3]; // observed from implementation
  }
  ...
  {
    var b := 4;
    var p: seq<nat> := [2, 3, 3, 3];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [3, 0, 0, 0]; // observed from implementation
  }
  ...
  {
    var b := 9;
    var p: seq<nat> := [8, 5, 2, 0];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [8, 5, 2, 1]; // observed from implementation
  }
  ...
  {
    var b := 10;
    var p: seq<nat> := [9, 7, 2, 0];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [9, 7, 2, 1]; // observed from implementation
  }
  ...
  {
    var b := 9;
    var p: seq<nat> := [2, 8, 3, 7];
    var r := bibble_increment(b, p);
    expect bibble(b, r);
    expect r == [2, 8, 3, 8]; // observed from implementation
  }
...
method TestsForbibble_flip()
{
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [0, 0, 0, 4]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [3, 0, 3, 0]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [0, 0, 2, 5]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [1, 0, 0, 0]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [0, 3, 6, 8]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [0, 2, 7, 9]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [6, 0, 5, 1]; // observed from implementation
  }
...
method TestsForn_complement()
{
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [3, 0, 3, 1]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [0, 0, 2, 6]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [1, 0, 0, 1]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [0, 3, 7, 0]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [0, 2, 8, 0]; // observed from implementation
  }
  ...
  //   POST Q1: bibble(b, com)
  {
    ...
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [6, 0, 5, 2]; // observed from implementation
  }
