...
method TestsForremoveElement()
{
  ...
  //   POST Q1: forall k: int {:trigger nums[k]} :: 0 < k < i < nums.Length ==> nums[k] != val
  {
    ...
    // runtime error: at _module.__default.removeElement(BigInteger[] nums, BigInteger val) in C:\cygwin64\tmp\DafnyCBT_z14vmd1ix5u\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_z14vmd1ix5u\runner.cs:line 6097
    // expect forall k: int :: 0 < k < i < nums.Length ==> nums[k] != val;
  }
