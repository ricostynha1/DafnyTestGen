...
method TestsForSelectionSort()
{
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6311
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6391
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6431
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6471
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__5() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6511
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6551
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6591
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6631
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6213
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_chugucyo3a0\runner.cs:line 6671
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
