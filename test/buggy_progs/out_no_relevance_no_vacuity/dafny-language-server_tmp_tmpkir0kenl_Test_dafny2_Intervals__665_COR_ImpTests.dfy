...
method TestsForRoundDown()
{
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_jydvrqblwhh\runner.cs:line 6731
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_jydvrqblwhh\runner.cs:line 6152
    // expect r == -1;
  }
