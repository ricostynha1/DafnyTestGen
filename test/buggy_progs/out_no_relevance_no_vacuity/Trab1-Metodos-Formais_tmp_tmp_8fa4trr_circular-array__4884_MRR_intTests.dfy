...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Trab1-Metodos-Formais_tmp_tmp_8fa4trr_circular-array__4884_MRR_int.dfy
// Method: Enqueue
// Generated: 2026-04-25 00:42:31
...
method TestsForGetAt()
{
  ...
  //   POST Q1: e == Elements[i]
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_fc4roujsejc\runner.cs:line 2416
...
method TestsForAsSequence()
{
  ...
  //   POST Q1: s == Elements
  {
    ...
    // actual runtime state: s=[2, -1]
    // expect s == [2]; // LHS=[2, -1], RHS=[2]
  }
  ...
  //   POST Q1: s == Elements
  {
    ...
    obj.Repr := {obj, obj.arr};
    var s := obj.AsSequence();
    // actual runtime state: s=[-10, -1]
    // expect s == [-7]; // LHS=[-10, -1], RHS=[-7]
  }
  ...
  //   POST Q1: s == Elements
  {
    ...
    obj.Repr := {obj, obj.arr};
    var s := obj.AsSequence();
    // actual runtime state: s=[-7, -1]
    // expect s == [2]; // LHS=[-7, -1], RHS=[2]
  }
  ...
  //   POST Q1: s == Elements
  {
    ...
    obj.Repr := {obj, obj.arr};
    var s := obj.AsSequence();
    // actual runtime state: s=[-6, 3]
    // expect s == [-8, -1]; // LHS=[-6, 3], RHS=[-8, -1]
  }
