...
method TestsForInsertIntoSorted()
{
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect forall i: int :: 0 <= i < limit ==> a[i] in b[..];
    expect forall i: int :: 0 <= i < limit + 1 ==> b[i] > 0;
    expect b[..] == [3, 5, 7, 9]; // observed from implementation
  }
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect forall i: int :: 0 <= i < limit ==> a[i] in b[..];
    expect forall i: int :: 0 <= i < limit + 1 ==> b[i] > 0;
    expect b[..] == [4, 7, 8, 9]; // observed from implementation
  }
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect forall i: int :: 0 <= i < limit ==> a[i] in b[..];
    expect forall i: int :: 0 <= i < limit + 1 ==> b[i] > 0;
    expect b[..] == [4, 6, 7, 9]; // observed from implementation
  }
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect forall i: int :: 0 <= i < limit ==> a[i] in b[..];
    expect forall i: int :: 0 <= i < limit + 1 ==> b[i] > 0;
    expect b[..] == [5, 6, 9, 10]; // observed from implementation
  }
  ...
  //   POST Q5: forall i: int {:trigger b[i]} :: 0 <= i < limit + 1 ==> b[i] > 0
  {
    ...
    expect forall i: int :: 0 <= i < limit ==> a[i] in b[..];
    expect forall i: int :: 0 <= i < limit + 1 ==> b[i] > 0;
    expect b[..] == [2, 3, 4, 9]; // observed from implementation
  }
