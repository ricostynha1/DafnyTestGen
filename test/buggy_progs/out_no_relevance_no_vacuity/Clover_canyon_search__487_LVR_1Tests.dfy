...
method TestsForCanyonSearch()
{
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 6054
    // expect d == 1;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 6196
    // expect d == 12;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 6231
    // expect d == 13;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 6266
    // expect d == 17;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_o0a3wfdet0o\runner.cs:line 6301
    // expect d == 12;
  }
