...
method TestsForRoundDown()
{
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_2jcv035prpy\runner.cs:line 6917
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_2jcv035prpy\runner.cs:line 6269
    // expect r == -1;
  }
