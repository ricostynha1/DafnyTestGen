...
method TestsForbinarySearch()
{
  ...
  //   POST Q6: index >= a.Length
  {
    ...
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_yr0gxjzu10n\runner.cs:line 5981
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_yr0gxjzu10n\runner.cs:line 6042
    // expect index == 1;
  }
