...
method TestsFormlastMaximum()
{
  ...
  //   POST Q4: forall l: int {:trigger v[l]} :: i < l < v.Length ==> v[i] > v[l]
  {
    ...
    // runtime error: at _module.__default.mlastMaximum(BigInteger[] v) in C:\cygwin64\tmp\DafnyCBT_l3o4gogf3sk\runner.cs:line 6639
    // runtime error: at _module.__default.TestCase__30() in C:\cygwin64\tmp\DafnyCBT_l3o4gogf3sk\runner.cs:line 7537
    // expect i == 1;
  }
