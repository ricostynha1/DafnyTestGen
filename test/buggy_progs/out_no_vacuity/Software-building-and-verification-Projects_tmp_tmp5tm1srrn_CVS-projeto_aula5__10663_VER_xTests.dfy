...
method TestsForcontains()
{
  ...
  //   POST Q9: v in elems
  {
    ...
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.GrowingSet.contains(BigInteger v) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12498
    // expect b == true || b == false;
  }
...
method TestsForfind()
{
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__107() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11528
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__108() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11572
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__110() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11658
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__111() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11702
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__112() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11746
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__113() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11790
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__114() in C:\cygwin64\tmp\DafnyCBT_wi3tnnwmurr\runner.cs:line 11834
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
