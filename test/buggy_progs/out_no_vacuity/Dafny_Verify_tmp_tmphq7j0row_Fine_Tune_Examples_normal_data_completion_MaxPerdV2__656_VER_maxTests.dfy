...
method TestsFormax()
{
  ...
  //   POST Q2: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 6252
    // expect max == 0;
  }
  ...
  //   POST Q2: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 6287
    // expect max == 10;
  }
  ...
  //   POST Q3: forall j: int {:trigger a[j]} :: 0 <= j && j < n ==> a[j] <= max
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.max(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 5971
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_2rv52bj20sw\runner.cs:line 6323
    // expect max == 0;
  }
