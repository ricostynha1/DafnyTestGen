...
method TestsFormin()
{
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 5993
    // expect min == -10;
  }
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 6238
    // expect min == 0;
  }
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_1w4jqdkbnez\runner.cs:line 6273
    // expect min == 8;
  }
