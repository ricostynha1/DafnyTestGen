...
method TestsForbinarySearch()
{
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 5970
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 6027
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 5970
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 6094
    // expect index == 1;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 5970
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 6228
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 5970
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 6264
    // expect index == 3;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 5970
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_sbaqojqarue\runner.cs:line 6330
    // expect index == 0;
  }
