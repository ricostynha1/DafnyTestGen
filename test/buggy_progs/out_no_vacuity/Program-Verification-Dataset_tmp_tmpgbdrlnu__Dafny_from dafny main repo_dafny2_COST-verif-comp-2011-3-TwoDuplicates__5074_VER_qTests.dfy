...
method TestsForSearch()
{
  ...
  {
    var a := new int[8] [4, 5, 5, 4, 5, 5, 5, 5];
    var p, q := Search(a);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5919
  ...
  {
    var a := new int[8] [2, 3, 4, 1, 4, 5, 0, 0];
    var p, q := Search(a);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5954
    // expect p == 0 || p == 4;
    // expect q == 4 || q == 0;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    var a := new int[8] [3, 2, 2, 0, 0, 0, 4, 0];
    var p, q := Search(a);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_llqsxr4hmpw\runner.cs:line 5993
    // expect p == 2 || p == 0;
    // expect q == 0 || q == 2;
  }
