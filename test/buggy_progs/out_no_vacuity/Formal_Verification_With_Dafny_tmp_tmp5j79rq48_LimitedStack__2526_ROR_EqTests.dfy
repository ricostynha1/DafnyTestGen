...
method TestsForPeek()
{
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__14() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7455
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__15() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7489
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__16() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7523
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__18() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7591
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__19() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7625
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__20() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7658
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__21() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7693
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__22() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7727
    // expect elem == obj.arr[obj.top];
  }
  ...
  //   POST Q1: elem == arr[top]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Peek() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9006
    // runtime error: at _module.__default.TestCase__23() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7761
    // expect elem == obj.arr[obj.top];
  }
...
method TestsForPush()
{
  ...
  //   POST Q2: !old(Empty()) ==> forall i: int {:trigger old(arr[i])} {:trigger arr[i]} :: 0 <= i <= old(top) ==> arr[i] == old(arr[i])
  {
    ...
    obj.Push(elem);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Push(BigInteger elem) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9015
    // runtime error: at _module.__default.TestCase__25() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7835
    // expect obj.Valid() && obj.top == old_top + 1 && obj.arr[obj.top] == elem;
  }
  ...
  //   POST Q2: !old(Empty()) ==> forall i: int {:trigger old(arr[i])} {:trigger arr[i]} :: 0 <= i <= old(top) ==> arr[i] == old(arr[i])
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Push(BigInteger elem) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9015
    // runtime error: at _module.__default.TestCase__29() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 7974
    // expect obj.Valid() && obj.top == old_top + 1 && obj.arr[obj.top] == elem;
  }
  ...
  //   POST Q2: !old(Empty()) ==> forall i: int {:trigger old(arr[i])} {:trigger arr[i]} :: 0 <= i <= old(top) ==> arr[i] == old(arr[i])
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Push(BigInteger elem) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9015
    // runtime error: at _module.__default.TestCase__30() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8009
    // expect obj.Valid() && obj.top == old_top + 1 && obj.arr[obj.top] == elem;
  }
  ...
  //   POST Q2: !old(Empty()) ==> forall i: int {:trigger old(arr[i])} {:trigger arr[i]} :: 0 <= i <= old(top) ==> arr[i] == old(arr[i])
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Push(BigInteger elem) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9015
    // runtime error: at _module.__default.TestCase__31() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8043
    // expect obj.Valid() && obj.top == old_top + 1 && obj.arr[obj.top] == elem;
  }
...
method TestsForPop()
{
  ...
  //   POST Q2: elem == arr[old(top)]
  {
    ...
    var elem := obj.Pop();
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.TestCase__34() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8147
    // runtime error: at _module.__default._Main(ISequence`1 args) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8876
  ...
  //   POST Q2: elem == arr[old(top)]
  {
    ...
    var elem := obj.Pop();
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.TestCase__35() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8192
    // runtime error: at _module.__default._Main(ISequence`1 args) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8878
    // expect elem == obj.arr[old_top];
    // expect obj.Valid() && obj.top == old_top - 1;
  }
  ...
  //   POST Q2: elem == arr[old(top)]
  {
    ...
    var elem := obj.Pop();
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.TestCase__37() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8284
    // runtime error: at _module.__default._Main(ISequence`1 args) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8882
    // expect elem == obj.arr[old_top];
    // expect obj.Valid() && obj.top == old_top - 1;
  }
...
method TestsForShift()
{
  ...
  //   POST Q6: forall i: int {:trigger arr[i]} :: 0 <= i && i < capacity - 1 ==> arr[i] == old(arr[i + 1])
  {
    ...
    obj.Shift();
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Shift() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9032
    // runtime error: at _module.__default.TestCase__39() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 8355
    // expect obj.top == 0;
  }
...
method TestsForPush2()
{
  ...
  //   POST Q8: forall i: int {:trigger arr[i]} :: 0 <= i && i < capacity - 1 ==> arr[i] == old(arr[i + 1])
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.LimitedStack.Shift() in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9032
    // runtime error: at _module.LimitedStack.Push2(BigInteger elem) in C:\cygwin64\tmp\DafnyCBT_racb40fo3uk\runner.cs:line 9040
    // expect obj.top == 0;
  }
