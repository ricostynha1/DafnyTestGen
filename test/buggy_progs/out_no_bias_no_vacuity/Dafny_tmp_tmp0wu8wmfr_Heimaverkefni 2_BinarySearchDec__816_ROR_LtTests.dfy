...
method TestsForSearchRecursive()
{
  ...
  //   POST Q4: forall r: int {:trigger a[r]} | k <= r < j :: a[r] < x
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_bkt1tt4vybx\runner.cs:line 1656
    // expect k == 1;
  }
