...
method TestsFormin()
{
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 5992
    // expect min == 401;
  }
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 6096
    // expect min == 0;
  }
  ...
  //   POST Q3: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__5() in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 6130
    // expect min == -175;
  }
  ...
  //   POST Q2: forall i: int {:trigger a[i]} :: 0 <= i && i < n ==> a[i] >= min
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.min(BigInteger[] a, BigInteger n) in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 5924
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_2fcgp1dpm0i\runner.cs:line 6199
    // expect min == -1;
  }
