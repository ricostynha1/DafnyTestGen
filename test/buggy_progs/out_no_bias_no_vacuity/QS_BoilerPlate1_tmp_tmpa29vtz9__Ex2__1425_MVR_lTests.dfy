...
method TestsForsortAux()
{
  ...
  //   POST Q3: a[r..] == old(a[r..])
  {
    ...
    // runtime error: at _module.__default.mergeArr(BigInteger[] a, BigInteger l, BigInteger m, BigInteger r) in C:\cygwin64\tmp\DafnyCBT_uttwperrxk3\runner.cs:line 6709
    // runtime error: at _module.__default.sortAux(BigInteger[] a, BigInteger l, BigInteger r) in C:\cygwin64\tmp\DafnyCBT_uttwperrxk3\runner.cs:line 6737
    // expect sorted(a[l .. r]);
    // expect a[..l] == old_a_l;
    // expect a[r..] == old_a_r;
  }
