...
method TestsForSearch2PowLoop()
{
  ...
  //   POST Q3: forall r: int {:trigger a[r]} | k <= r < i + n :: a[r] >= x
  {
    ...
    // runtime error: at _module.__default.Search2PowLoop(BigInteger[] a, BigInteger i, BigInteger n, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_hs14qz32uia\runner.cs:line 6565
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_hs14qz32uia\runner.cs:line 6642
  ...
  //   POST Q3: forall r: int {:trigger a[r]} | k <= r < i + n :: a[r] >= x
  {
    var a := new int[2] [22, -2];
    var i := 1;
    var n := 1;
    var x := -1;
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search2PowLoop(BigInteger[] a, BigInteger i, BigInteger n, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_hs14qz32uia\runner.cs:line 6565
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_hs14qz32uia\runner.cs:line 6852
    // expect 0 <= i <= i + n <= a.Length; // PRE-CHECK
    // expect Is2Pow(n + 1); // PRE-CHECK
    var k := Search2PowLoop(a, i, n, x);
    // expect i <= k <= i + n;
