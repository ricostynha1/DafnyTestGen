...
method TestsForInitArray()
{
  ...
  //   POST Q1: forall i: int {:trigger a[i]} :: 0 <= i < a.Length ==> a[i] == d
  {
    ...
    // runtime error: at _module.__default.InitArray[__T](__T[] a, __T d) in C:\cygwin64\tmp\DafnyTestGen_ahldulkir2t\runner.cs:line 6042
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyTestGen_ahldulkir2t\runner.cs:line 6094
    // expect a[..] == [];
  }
  ...
  //   POST Q1: forall i: int {:trigger a[i]} :: 0 <= i < a.Length ==> a[i] == d
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.InitArray[__T](__T[] a, __T d) in C:\cygwin64\tmp\DafnyTestGen_ahldulkir2t\runner.cs:line 6042
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyTestGen_ahldulkir2t\runner.cs:line 6163
    // expect a[..] == [];
  }
