...
method TestsForSelectionSort()
{
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_pqefwlnywla\runner.cs:line 5961
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_pqefwlnywla\runner.cs:line 6060
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.SelectionSort(BigInteger[] a) in C:\cygwin64\tmp\DafnyCBT_pqefwlnywla\runner.cs:line 5961
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_pqefwlnywla\runner.cs:line 6139
    // expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    // expect multiset(a[..]) == old_multiset_a;
  }
...
method TestsForQuickSort()
{
  ...
  //   POST Q2: multiset(a[..]) == old(multiset(a[..]))
  {
    ...
    expect forall i: int, j: int :: 0 <= i < j < a.Length ==> a[i] <= a[j];
    expect multiset(a[..]) == old_multiset_a;
    expect old_multiset_a == multiset{-10, -2}; // observed from implementation
    expect a[..] == [-10, -2]; // observed from implementation
  }
