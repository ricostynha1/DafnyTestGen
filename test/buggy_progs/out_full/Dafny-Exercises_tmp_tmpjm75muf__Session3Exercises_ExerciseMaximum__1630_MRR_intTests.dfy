...
method TestsFormlastMaximum()
{
  ...
  //   POST Q4: forall l: int {:trigger v[l]} :: i < l < v.Length ==> v[i] > v[l]
  {
    ...
    // runtime error: at _module.__default.mlastMaximum(BigInteger[] v) in C:\cygwin64\tmp\DafnyCBT_zxue1fwj5sb\runner.cs:line 6575
    // runtime error: at _module.__default.TestCase__27() in C:\cygwin64\tmp\DafnyCBT_zxue1fwj5sb\runner.cs:line 7389
    // expect i == 1;
  }
