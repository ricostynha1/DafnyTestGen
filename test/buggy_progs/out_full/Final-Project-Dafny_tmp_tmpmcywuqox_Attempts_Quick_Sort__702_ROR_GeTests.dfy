...
method TestsForthreshold()
{
  ...
  //   POST Q3: multiset(Seq_1) + multiset(Seq_2) == multiset(Seq)
  {
    ...
    var Seq: seq<int> := [2];
    var Seq_1, Seq_2 := threshold(thres, Seq);
    // actual runtime state: Seq_1=[], Seq_2=[2]
    // expect (forall x: int | x in Seq_1 :: x <= thres) && forall x: int | x in Seq_2 :: x >= thres; // got false
    // expect |Seq_1| + |Seq_2| == |Seq|; // LHS=1, RHS=1
    // expect multiset(Seq_1) + multiset(Seq_2) == multiset(Seq); // LHS=multiset{2}, RHS=multiset{2}
  }
  ...
  {
    var thres := -10;
    var Seq: seq<int> := [-10, -4];
    var Seq_1, Seq_2 := threshold(thres, Seq);
    // actual runtime state: Seq_1=[-10, -4], Seq_2=[]
    // expect (forall x: int | x in Seq_1 :: x <= thres) && forall x: int | x in Seq_2 :: x >= thres; // got false
    // expect |Seq_1| + |Seq_2| == |Seq|; // LHS=2, RHS=2
    // expect multiset(Seq_1) + multiset(Seq_2) == multiset(Seq); // LHS=multiset{-10, -4}, RHS=multiset{-10, -4}
  }
  ...
  //   POST Q3: multiset(Seq_1) + multiset(Seq_2) == multiset(Seq)
  {
    ...
    var Seq: seq<int> := [4];
    var Seq_1, Seq_2 := threshold(thres, Seq);
    // actual runtime state: Seq_1=[4], Seq_2=[]
    // expect (forall x: int | x in Seq_1 :: x <= thres) && forall x: int | x in Seq_2 :: x >= thres; // got false
    // expect |Seq_1| + |Seq_2| == |Seq|; // LHS=1, RHS=1
    // expect multiset(Seq_1) + multiset(Seq_2) == multiset(Seq); // LHS=multiset{4}, RHS=multiset{4}
  }
  ...
  //   POST Q3: multiset(Seq_1) + multiset(Seq_2) == multiset(Seq)
  {
    ...
    var Seq: seq<int> := [2];
    var Seq_1, Seq_2 := threshold(thres, Seq);
    // actual runtime state: Seq_1=[2], Seq_2=[]
    // expect (forall x: int | x in Seq_1 :: x <= thres) && forall x: int | x in Seq_2 :: x >= thres; // got false
    // expect |Seq_1| + |Seq_2| == |Seq|; // LHS=1, RHS=1
    // expect multiset(Seq_1) + multiset(Seq_2) == multiset(Seq); // LHS=multiset{2}, RHS=multiset{2}
  }
  ...
  // FAILING: expects commented out; see VAL/RHS annotations below
  // Test case for combination {1}/Othres=0/R9:
  //   POST Q1: (forall x: int {:trigger x in Seq_1} | x in Seq_1 :: x <= thres) && forall x: int {:trigger x in Seq_2} | x in Seq_2 :: x >= thres
  //   POST Q2: |Seq_1| + |Seq_2| == |Seq|
  //   POST Q3: multiset(Seq_1) + multiset(Seq_2) == multiset(Seq)
  {
