...
method TestsForbinarySearch()
{
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 6009
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x  // VACUOUS (forced true by other literals for this ins)
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 6075
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 6109
    // expect index == 1;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_tdeuqrewl0d\runner.cs:line 6246
    // expect index == 3;
  }
