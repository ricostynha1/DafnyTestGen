...
method TestsForDutchFlag()
{
  ...
  //   POST Q1: forall i: int, j: int {:trigger a[j], a[i]} :: 0 <= i < j < a.Length ==> Below(a[i], a[j])  // VACUOUS (forced true by other literals for this ins)
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    var a := new Color[0] [];
    DutchFlag(a);
  ...
  //   POST Q2: multiset(a[..]) == multiset(old(a[..]))
  {
    ...
    // runtime error: at _module.__default.DutchFlag(_IColor[] a) in C:\cygwin64\tmp\DafnyCBT_bqtrmq1cu0n\runner.cs:line 5835
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_bqtrmq1cu0n\runner.cs:line 5905
    // expect a[..] == [Blue];
  }
