...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Clover_canyon_search__487_LVR_1.dfy
// Method: CanyonSearch
// Generated: 2026-04-24 09:28:20
...
method TestsForCanyonSearch()
{
  ...
  //   PRE:  forall i: int, j: int {:trigger b[j], b[i]} :: 0 <= i < j < b.Length ==> b[i] <= b[j]
  //   POST Q1: exists i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length && d == if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]  // VACUOUS (forced true by other literals for this ins)
  {
    var a := new int[1] [-1];
    var b := new int[1] [-10];
    var d := CanyonSearch(a, b);
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 6091
    // expect d == 1;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 6196
    // expect d == 15;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 6266
    // expect d == 6;
  }
  ...
  //   POST Q2: forall i: int, j: int {:trigger b[j], a[i]} :: 0 <= i < a.Length && 0 <= j < b.Length ==> d <= if a[i] < b[j] then b[j] - a[i] else a[i] - b[j]
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.CanyonSearch(BigInteger[] a, BigInteger[] b) in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 5930
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_rd2sm1sgfwu\runner.cs:line 6301
    // expect d == 19;
  }
