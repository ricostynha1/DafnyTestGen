...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\Software-building-and-verification-Projects_tmp_tmp5tm1srrn_CVS-projeto_aula5__10663_VER_x.dfy
// Method: contains
// Generated: 2026-04-24 10:59:00
...
method TestsForcontains()
{
  ...
  //   POST Q9: v in elems
  {
    ...
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.GrowingSet.contains(BigInteger v) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12498
    // expect b == true || b == false;
  }
...
method TestsForadd()
{
  ...
  //   POST Q1: RepInv()
  {
    var n := 3;
    var obj := new Set(n);
    var tmp_store := new int[3] [-2, 5, 10];
    obj.store := tmp_store;
    obj.nelems := 2;
    obj.Repr := {obj, obj.store};
    var v := 2;
    obj.add(v);
    expect tmp_store[..] == [-2, 5, 2]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    var n := 9;
    var obj := new Set(n);
    var tmp_store := new int[3] [5, -2, 10];
    obj.store := tmp_store;
    obj.nelems := 2;
    obj.Repr := {obj, obj.store};
    var v := -1;
    obj.add(v);
    expect tmp_store[..] == [5, -2, -1]; // observed from implementation
  }
  ...
  //   POST Q1: RepInv()
  {
    var n := 2;
    var obj := new Set(n);
    var tmp_store := new int[3] [-1, 5, -1];
    obj.store := tmp_store;
    obj.nelems := 2;
    obj.Repr := {obj, obj.store};
    var v := 2;
    obj.add(v);
    expect tmp_store[..] == [-1, 5, 2]; // observed from implementation
  }
...
method TestsForfind()
{
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__107() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11528
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__108() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11572
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__110() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11658
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__111() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11702
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__112() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11746
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__113() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11790
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 12537
    // runtime error: at _module.__default.TestCase__114() in C:\cygwin64\tmp\DafnyCBT_2o4l5iwsp0p\runner.cs:line 11834
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
