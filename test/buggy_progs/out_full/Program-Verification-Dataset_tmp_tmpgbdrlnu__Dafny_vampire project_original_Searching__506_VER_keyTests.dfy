...
method TestsForFind()
{
  ...
  //   POST Q4: index >= 0
  {
    ...
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5960
    // expect index == 1;
  }
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5993
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 6106
    // expect 0 <= index ==> index < blood.Length && blood[index] == key;
    // expect index < 0 ==> forall k: int :: 0 <= k < blood.Length ==> blood[k] != key;
  }
  ...
  //   POST Q2: index < 0 ==> forall k: int {:trigger blood[k]} :: 0 <= k < blood.Length ==> blood[k] != key
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Find(BigInteger[] blood, BigInteger key) in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 5925
    // runtime error: at _module.__default.TestCase__9() in C:\cygwin64\tmp\DafnyCBT_2ptnas1gdwn\runner.cs:line 6295
    // expect 0 <= index ==> index < blood.Length && blood[index] == key;
    // expect index < 0 ==> forall k: int :: 0 <= k < blood.Length ==> blood[k] != key;
  }
