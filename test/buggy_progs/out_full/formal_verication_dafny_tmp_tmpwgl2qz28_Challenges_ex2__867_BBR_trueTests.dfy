...
method TestsForAllow42()
{
  ...
  //   POST Q3: err == true
  {
    ...
    // runtime error: at Dafny.Helpers.EuclideanDivision(BigInteger a, BigInteger b) in C:\cygwin64\tmp\DafnyCBT_l0b5xqiascr\runner.cs:line 2027
    // expect z == 0;
    // expect err == true;
  }
  ...
  //   POST Q3: err == true
  {
    ...
    // runtime error: Unhandled exception. System.DivideByZeroException: Attempted to divide by zero.
    // runtime error: at System.Numerics.BigInteger.op_Division(BigInteger dividend, BigInteger divisor)
    // runtime error: at Dafny.Helpers.EuclideanDivision(BigInteger a, BigInteger b) in C:\cygwin64\tmp\DafnyCBT_l0b5xqiascr\runner.cs:line 2035
    // expect z == 0;
    // expect err == true;
  }
