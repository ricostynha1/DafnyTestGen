...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\dafleet_tmp_tmpa2e4kb9v_0001-0050_0005-longest-palindromic-substring__6996_VER_loop_counter_inner2.dfy
// Method: expand_from_center
// Generated: 2026-04-24 09:39:19
...
predicate inbound_radius(s': string, c: int, r: int)
  decreases s', c, r
{
  r >= 0 &&
  0 <= c - r &&
...
predicate palindromic_radius(s': string, c: int, r: int)
...
predicate max_radius(s': string, c: int, r: int)
  decreases s', c, r
{
...
predicate max_interval_for_same_center(s: string, k: int, lo: int, hi: int)
  decreases s, k, lo, hi
{
  0 <= lo <= hi <= |s| &&
  lo + hi == k &&
...
method TestsForexpand_from_center()
{
  // Test case for combination {1}/Rel:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  {
    var s: seq<char> := ['~', '7', 'r', '8'];
    var i0 := 3;
    var j0 := 3;
  ...
  // Test case for combination {1}/Bi0=0:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  ...
  // Test case for combination {1}/Bi0=1:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  ...
  // Test case for combination {1}/Bj0=1:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  ...
  // Test case for combination {2}/Bi0=0:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  {
    var s: seq<char> := ['c', 'b', 'c'];
    var i0 := 0;
    var j0 := 3;
    expect 0 <= i0 <= j0 <= |s|; // PRE-CHECK
    expect palindromic(s, i0, j0); // PRE-CHECK
  ...
  // Test case for combination {2}/Bi0=1:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  {
    var s: seq<char> := ['c', 'd', 'c'];
    var i0 := 1;
    var j0 := 2;
    expect 0 <= i0 <= j0 <= |s|; // PRE-CHECK
    expect palindromic(s, i0, j0); // PRE-CHECK
  ...
  // Test case for combination {2}/Bj0=1:
  //   PRE:  0 <= i0 <= j0 <= |s|
  //   PRE:  palindromic(s, i0, j0)
  //   POST Q1: 0 <= lo <= hi <= |s| && palindromic(s, lo, hi)
  //   POST Q2: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) && i + j == i0 + j0 :: j - i <= hi - lo
  {
    var s: seq<char> := ['B', 'c', 'c'];
    var i0 := 1;
    var j0 := 1;
    expect 0 <= i0 <= j0 <= |s|; // PRE-CHECK
    expect palindromic(s, i0, j0); // PRE-CHECK
...
method TestsForlongestPalindrome()
{
  // Test case for combination {1}/Rel:
  //   POST Q1: 0 <= lo <= hi <= |s| && ans == s[lo .. hi]
  //   POST Q2: palindromic(s, lo, hi)
  //   POST Q3: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) :: j - i <= hi - lo
  {
    var s: seq<char> := ['~', ','];
  ...
  // Test case for combination {2}/Blo=1:
  //   POST Q1: 0 <= lo <= hi <= |s| && ans == s[lo .. hi]
  //   POST Q2: palindromic(s, lo, hi)
  //   POST Q3: forall i: int, j: int {:trigger palindromic(s, i, j)} | 0 <= i <= j <= |s| && palindromic(s, i, j) :: j - i <= hi - lo
  {
...
method Main()
{
  TestsForexpand_from_center();
  print "TestsForexpand_from_center: all tests passed!\n";
  TestsForlongestPalindrome();
  print "TestsForlongestPalindrome: all tests passed!\n";
  TestsForlongestPalindrome'();
  print "TestsForlongestPalindrome': all tests passed!\n";
}
