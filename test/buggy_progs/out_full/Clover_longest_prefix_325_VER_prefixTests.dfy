...
method TestsForLongestCommonPrefix()
{
  ...
  //   POST Q4: prefix == str2[0 .. |prefix|]
  {
    var str1: seq<char> := ['_', 'o'];
    var str2: seq<char> := ['_'];
    var prefix := LongestCommonPrefix(str1, str2);
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at System.Collections.Immutable.ImmutableArray`1.get_Item(Int32 index)
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_f2jzwk5fad3\runner.cs:line 1534
    // expect prefix == ['_'];
  }
  ...
  {
    var str1: seq<char> := ['Y', '-', '4', '=', '7'];
    var str2: seq<char> := ['Y', '-', '5', 'K', 'J'];
    var prefix := LongestCommonPrefix(str1, str2);
    expect prefix == ['Y', '-'];
  }
  ...
  // Test case for combination {3}/O|prefix|=1:
  //   POST Q1: |prefix| < |str1|
  //   POST Q2: prefix == str1[0 .. |prefix|]
  //   POST Q3: |prefix| < |str2|
  //   POST Q4: prefix == str2[0 .. |prefix|]
