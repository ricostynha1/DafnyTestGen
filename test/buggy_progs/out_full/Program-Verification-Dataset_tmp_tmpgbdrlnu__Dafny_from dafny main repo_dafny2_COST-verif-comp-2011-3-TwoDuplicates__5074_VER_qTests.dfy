...
method TestsForSearch()
{
  ...
  //   POST Q1: p != q && IsDuplicate(a, p) && IsDuplicate(a, q)
  {
    ...
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5919
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5954
    // expect p == 0 || p == 4;
    // expect q == 4 || q == 0;
  }
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5867
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_osrkv2nlc2n\runner.cs:line 5993
    // expect p == 2 || p == 0;
    // expect q == 0 || q == 2;
  }
