...
method TestsForlongest_increasing_subsequence()
{
  ...
  //   POST Q1: max >= 1
  {
    ...
    // runtime error: at _module.__default.longest__increasing__subsequence(BigInteger[] nums) in C:\cygwin64\tmp\DafnyCBT_wsfdeoi11nk\runner.cs:line 5940
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_wsfdeoi11nk\runner.cs:line 6028
    // expect max >= 1;
  }
