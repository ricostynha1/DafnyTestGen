...
method TestsForjoin()
{
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect c[..] == [9]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [9, 11, 18]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [8, 12]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [11]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [13]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [14]; // observed from implementation
  }
  ...
  //   POST Q6: forall i_2: int, j_2: int {:trigger b[j_2], c[i_2]} :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2]
  {
    ...
    expect forall i: int  :: 0 <= i < a.Length ==> c[i] == a[i];
    expect forall i_2: int, j_2: int :: a.Length <= i_2 < c.Length && 0 <= j_2 < b.Length && i_2 - j_2 == a.Length ==> c[i_2] == b[j_2];
    expect c[..] == [15]; // observed from implementation
  }
