...
method TestsForGetAt()
{
  ...
  //   POST Q1: e == Elements[i]
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_xbaulb213cp\runner.cs:line 2410
...
method TestsForAsSequence()
{
  ...
  //   POST Q1: s == Elements
  {
    ...
    obj.Repr := {obj, obj.arr};
    var s := obj.AsSequence();
    // actual runtime state: s=[11, 9]
    // expect s == [20]; // LHS=[11, 9], RHS=[20]
  }
