...
method TestsForRoundDown()
{
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6800
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6142
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6800
    // runtime error: at _module.__default.TestCase__3() in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6247
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6800
    // runtime error: at _module.__default.TestCase__7() in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6385
    // expect r == -1;
  }
  ...
  //   POST Q4: 0 > r
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.Rounding.RoundDown(BigInteger k) in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6800
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_bxvu2t2e3qg\runner.cs:line 6421
    // expect r == -1;
  }
