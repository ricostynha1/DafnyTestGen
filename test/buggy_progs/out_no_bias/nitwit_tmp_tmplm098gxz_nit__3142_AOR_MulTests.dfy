...
method TestsFornit_add()
{
  ...
  //   POST Q3: carry == 0 || carry == 1
  {
    ...
    expect nitness(b, carry);
    expect carry == 0 || carry == 1;
    expect z == 2; // observed from implementation
    expect carry == 0; // observed from implementation
  }
...
{
  // Test case for combination P{1}/{2}/Bb=2:
  //   PRE:  valid_base(b)
  //   PRE:  c == 0 || c == 1
  //   PRE:  nitness(b, x)
  //   PRE:  nitness(b, y)
  ...
  // Test case for combination P{1}/{2}/Rel:
  //   PRE:  valid_base(b)
  //   PRE:  c == 0 || c == 1
  //   PRE:  nitness(b, x)
  //   PRE:  nitness(b, y)
  ...
  // Test case for combination P{2}/{2}/Rel:
  //   PRE:  valid_base(b)
  //   PRE:  c == 0 || c == 1
  //   PRE:  nitness(b, x)
  //   PRE:  nitness(b, y)
...
method TestsForbibble_flip()
{
  ...
  //   POST Q1: bibble(b, fp)
  {
    ...
    var fp := bibble_flip(b, p);
    expect bibble(b, fp);
    expect fp == [1769, 1769, 1770, 1770]; // observed from implementation
  }
...
method TestsForn_complement()
{
  ...
  {
    var b := 5810;
    var p: seq<nat> := [3758, 2092, 2731, 2246];
    var com := n_complement(b, p);
    expect bibble(b, com);
    expect com == [2051, 3717, 3078, 3564]; // observed from implementation
  }
