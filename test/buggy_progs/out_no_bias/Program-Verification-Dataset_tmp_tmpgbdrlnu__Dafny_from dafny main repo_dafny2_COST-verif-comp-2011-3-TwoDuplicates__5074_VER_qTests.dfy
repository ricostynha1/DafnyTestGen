...
method TestsForSearch()
{
  ...
  //   POST Q1: p != q && IsDuplicate(a, p) && IsDuplicate(a, q)
  {
    ...
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_tt3nb24yjv1\runner.cs:line 5850
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_tt3nb24yjv1\runner.cs:line 5898
  ...
  //   POST Q3: IsDuplicate(a, q)
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.__default.Search(BigInteger[] a, BigInteger& p, BigInteger& q) in C:\cygwin64\tmp\DafnyCBT_tt3nb24yjv1\runner.cs:line 5850
    // runtime error: at _module.__default.TestCase__1() in C:\cygwin64\tmp\DafnyCBT_tt3nb24yjv1\runner.cs:line 5929
    // expect p == 1 || p == 0;
    // expect q == 0 || q == 1;
  }
