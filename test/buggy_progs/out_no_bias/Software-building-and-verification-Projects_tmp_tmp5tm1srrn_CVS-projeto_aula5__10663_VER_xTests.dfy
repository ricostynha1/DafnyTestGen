...
method TestsForcontains()
{
  ...
  //   POST Q9: v in elems
  {
    ...
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 12259
    // runtime error: at _module.GrowingSet.contains(BigInteger v) in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 12220
    // expect b == true || b == false;
  }
...
method TestsForfind()
{
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__108() in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 11435
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__109() in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 11478
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
  ...
  //   POST Q3: r >= 0 ==> x in elems
  {
    ...
    // runtime error: Unhandled exception. System.IndexOutOfRangeException: Index was outside the bounds of the array.
    // runtime error: at _module.GrowingSet.find(BigInteger x) in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 12259
    // runtime error: at _module.__default.TestCase__110() in C:\cygwin64\tmp\DafnyCBT_xwwnewfcmpk\runner.cs:line 11521
    // expect r < 0 ==> x !in obj.elems;
    // expect r >= 0 ==> x in obj.elems;
  }
