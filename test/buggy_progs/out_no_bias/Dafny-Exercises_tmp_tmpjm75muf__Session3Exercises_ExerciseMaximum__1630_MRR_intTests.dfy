...
method TestsFormlastMaximum()
{
  ...
  //   POST Q4: forall l: int {:trigger v[l]} :: i < l < v.Length ==> v[i] > v[l]
  {
    ...
    // runtime error: at _module.__default.mlastMaximum(BigInteger[] v) in C:\cygwin64\tmp\DafnyCBT_wkjc5dyyoyz\runner.cs:line 6543
    // runtime error: at _module.__default.TestCase__27() in C:\cygwin64\tmp\DafnyCBT_wkjc5dyyoyz\runner.cs:line 7360
    // expect i == 1;
  }
