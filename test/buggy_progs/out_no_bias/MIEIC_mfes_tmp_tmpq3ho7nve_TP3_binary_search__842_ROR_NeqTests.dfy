...
method TestsForbinarySearch()
{
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__0() in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 6009
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x  // VACUOUS (forced true by other literals for this ins)
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__2() in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 6075
    // expect index == 0;
  }
  ...
  //   POST Q1: -1 <= index
  //   POST Q2: index < a.Length
  //   POST Q3: index == -1  // VACUOUS (forced true by other literals for this ins)
  //   POST Q4: x !in a[..]
  {
    var a := new int[0] [];
    var x := 0;
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__4() in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 6141
    // expect index == 1;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__6() in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 6206
    // expect index == 0;
  }
  ...
  //   POST Q4: a[index] == x
  {
    ...
    // runtime error: Unhandled exception. System.Exception: unreachable alternative
    // runtime error: at _module.__default.binarySearch(BigInteger[] a, BigInteger x) in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 5952
    // runtime error: at _module.__default.TestCase__8() in C:\cygwin64\tmp\DafnyCBT_dvjv2dew5s2\runner.cs:line 6273
    // expect index == 0;
  }
