...
method TestsForLongestCommonPrefix()
{
  ...
  //   POST Q4: prefix == str2[0 .. |prefix|]
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_dvz0pe1qwuy\runner.cs:line 1534
    // expect prefix == [];
  }
