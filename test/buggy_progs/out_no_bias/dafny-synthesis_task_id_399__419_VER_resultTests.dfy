...
// Source: C:\Dados\Dafny\DafnyTestGen\test\buggy_progs\in\dafny-synthesis_task_id_399__419_VER_result.dfy
// Method: BitwiseXOR
// Generated: 2026-04-24 11:58:56
...
method TestsForBitwiseXOR()
{
  ...
  //   POST Q2: forall i: int {:trigger b[i]} {:trigger a[i]} {:trigger result[i]} :: 0 <= i < |result| ==> result[i] == a[i] ^ b[i]
  {
    ...
    // runtime error: at Dafny.Sequence`1.Select(BigInteger index) in C:\cygwin64\tmp\DafnyCBT_ryb5cfbz12p\runner.cs:line 1370
    // expect |result| == |a|;
